...
(function () {
  ...
  S = {
    ...
    credits: {
      enabled: !0,
      text: "duta-software.com",
      href: "http://www.duta-software.com",
      position: {
        align: "right",
        x: -10,
        verticalAlign: "bottom",
  ...
  Aa.prototype = {
    ...
    buildText: function (a) {
      ...
      }; r--;) b.removeChild(g[r]); ! f && !l && !u && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, Z && Z.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e, function (e, f) {
        var g, n = 0,
          ...
          if (e !== "" || g.length === 1) {
            ...
            if (e !== " ") {
              ...
              if (m) {
                ...
                (Z || u) && (l.length || s.length);) a.rotation = 0,
                o = a.getBBox(!0),
                q = o.width,
  ...
  Sa.prototype = {
    addLabel: function () {
      ...
      h = h.info,
      k;
      a.isDatetimeAxis && h && (k = b.dateTimeLabelFormats[h.higherRanks
        [f] || h.unitName]);
      this.isFirst = i;
      this.isLast = j;
  ...
  B.PlotLineOrBand.prototype = {
    render: function () {
      ...
      null, n.onGetPath);
      else { if (n.hide(), n.onGetPath = function () {
          n.show()
        },
  ...
  ha.prototype = {
    ...
    setTickPositions: function () {
      ...
      if (!b && (b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [b
        [0], b.pop()]), this.tickPositions = b, d && (d = d.apply(this, [this.min, this.max])))) this.tickPositions = b = d;
  ...
  ha.prototype.normalizeTimeTickInterval = function (a, b) {
    ...
    f = d[1],
    g;
    for (g = 0; g < c.length; g++) if (d = c[g], e = F[d
      [0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + F[c
      [g + 1]
      [0]]) / 2) break;
  ...
  mb.prototype = {
    ...
    adjustMargins: function (a, b) {
      ...
      this.display && !d.floating && o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, g) {
        f.test(e) && !q(a[g]) && (c[ib
          [g]] = s(c[ib
          [g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin, 12) + b[g]))
      })
    },
    render: function () {
      var a = this,
  ...
  E.prototype = {
    ...
    propFromSeries: function () {
      ...
      o(["inverted", "angular", "polar"], function (g) {
        ...
        for (e = d && d.length; ! f && e--;)(c = N[d
          [e].type]) && c.prototype[g] && (f = !0);
        a[g] = f
      })
    },
    linkSeries: function () {
  ...
  var Xb = B.CenteredSeriesMixin = {
    getCenter: function () {
      ...
      a = g < 2 || g === 2 && /%$/.test(h),
      e[g] = (/%$/.test(h) ? [d, b, f, e
        [2]][g] * parseFloat(h) / 100 : parseFloat(h)) + (a ? c : 0);
      e[3] > e[2] && (e[3] = e[2]);
      return e
    }
  },
  ...
  R.prototype = {
    ...
    setData: function (a, b, c, d) {
      ...
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function (a, b) {
        ...
        e.pointClass.prototype.applyOptions.apply(k, [a
          [c]]), e.updateParallelArrays(k, c), n && q(k.name))) m.names[k.x] = k.name;
        Ba(r[0]) && la(14, !0);
        e.data = [];
        e.options.data = a;
    ...
    generatePoints: function () {
      ...
      b = this.data = b;
      for (n = 0; n < g; n++) i = h + n,
      j ? m[n] = (new f).init(this, [d
        [n]].concat(ra(e[n]))) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[n])), m[n] = k),
      m[n].index = i;
    ...
    drawPoints: function () {
      ...
      else { if (r && (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, o ? l : m).attr(a).add(s)
    ...
    translate: function (a) {
      ...
      for (n = 0; n < l; n++) {
        ...
        o.labelPos = [a
          ...
          [1] + g + aa(h) * e, a
          [0] + f, a
          [1] + g, m < 0 ? "center" : o.half ? "right" : "left", h]
      }
    },
    drawGraph: null,
    drawPoints: function () {
  ...
  R.prototype.drawDataLabels = function () {
    ...
    o(e, function (e) {
      ...
      if (l && !h) e.dataLabel = l.destroy();
        ...
        w = !1;
        else { if (e.dataLabel = l = l.destroy(), s) e.connector = s.destroy()
        } else if (q(i)) {
          l = {
  ...
  if (N.pie) N.pie.prototype.drawDataLabels = function () {
    ...
    if (a.visible && (e.enabled || a._hasPointLabels)) {
      ...
      t && g && o(this.points, function (b) {
        ...
        C = x.connX,
        B = x.connY,
        k = m ? ["M", C + (y[6] === "left" ? 5 : -5), B, "C", C, B, 2 * y
          [2] - y
          [4], 2 * y
          [3] - y
          [5], y
  ...
  t(Fa.prototype, {
    ...
    setState: function (a, b) {
      ...
      if (! (a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && m.states && m.states[a] && m.states[a].enabled === !1)) {
        ...
        k && k.hide();
        else { if (a && i) if (g = i.radius, m = m.symbol || e.symbol, k && k.currentSymbol !== m && (k = k.destroy()), k) k[b ? "animate" : "attr"]({
            x: c - g,
            y: d - g
          });
