...
?>
<div class="modal" role="dialog" tabindex="-1" id="modalForm" mode="edit">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form class="form-horizontal" id="crudForm" enctype="multipart/form-data" action="<?=$update_url?>">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="form-button-save"><i class="icon wb-check"></i>&nbsp;<?= $this->l('form_update_changes'); ?></button>
...
<?=gc_theme_script_tag('datatables/js/datatables-edit.js');?>
...
<?php
if(!empty($this->custom_form_edit_css)){
  foreach ($this->custom_form_edit_css as $src) {
    ?>
<link rel="stylesheet" type="text/css" href="<?=$src?>?=_<?=uniqid()?>">    
    <?php
  }
...
?>
<?php
if(!empty($this->custom_form_edit_js)){
  foreach ($this->custom_form_edit_js as $src) {
    ?>
 <script type="text/javascript" src="<?=$src?>?=_<?=uniqid()?>"></script>  
    <?php
  }
