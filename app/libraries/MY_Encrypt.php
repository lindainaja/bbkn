...
class MY_Encrypt {
	...
	protected $_mcrypt_cipher = 'aes-256-ctr';
	...
	public function mcrypt_encode($data, $key)
	{
        ...
        $this->_iv     = openssl_random_pseudo_bytes(16);    // this value might vary depending on the cipher chosen
 
        return $this->_add_cipher_noise( $this->_get_cipher(). '.' . 
        	   bin2hex($this->_iv) . '.' . 
        	   bin2hex(openssl_encrypt($data, $this->_get_cipher(), $key, OPENSSL_RAW_DATA, $this->_iv)),$key);
	...
	public function mcrypt_decode($data, $key)
	{
		...
		return rtrim(openssl_decrypt(hex2bin($ciphertext), $this->cipher, $key, OPENSSL_RAW_DATA, hex2bin($this->iv)), "\0");
