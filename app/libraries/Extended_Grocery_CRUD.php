...
class Extended_Grocery_CRUD extends Grocery_CRUD{
    ...
    public $custom_form_css=[];
    public $custom_form_js=[];
    public $custom_form_add_css=[];
    public $custom_form_add_js=[];
    public $custom_form_edit_css=[];
    public $custom_form_edit_js=[];

    public $custom_list_css=[];
    public $custom_list_js=[];
    public $enable_save_and_download_button = false;
    ...
    public function enable_save_and_download($state=true){
        $this->enable_save_and_download_button = $state; 
    }
    public function add_custom_list_css(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_list_css[] = $path;
        }
    }
    public function add_custom_list_js(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_list_js[] = $path;
        }
    }
    public function add_custom_form_css(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_form_css[] = $path;
        }
    }
    public function add_custom_form_js(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_form_js[] = $path;
        }
    }
    public function add_custom_form_add_js(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_form_add_js[] = $path;
        }
    }
    public function add_custom_form_add_css(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_form_add_css[] = $path;
        }
    }
    public function add_custom_form_edit_js(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_form_edit_js[] = $path;
        }
    }
    public function add_custom_form_edit_css(){
        $args = func_get_args();
        foreach ($args as $path) {
            $this->custom_form_edit_css[] = $path;
        }
    }
