...
class Www_static extends CI_Controller
{
    ...
    public function js($filename)
    {
        ...
        $tmu = "app/modules/pindah_datang/assets";
        
        $js_code = "var gc={activeIframeDlId:'',onDownloadCallbackParam:{},onDownloadCallback:function(){},opt:{shdk:".json_encode(config_item('opt_shdk'))."},default_no_kel:".config_item('default_no_kel').",settings:{loadDataOnly:false},setSetting:function(k,v){this.settings[k]=v;return this;},oTable:null,oTableArray:[],oTableMapping:[],instance:function(){return this.oTableArray.length?oTableArray[0]:null},exclude_js:['jquery-ui-1.10.3.custom.min.js']};var site_url=function(){return '".site_url()."'};var base_url=function(){return '".base_url()."'};var gbs=function(){return '".base_url()."';};var tmu=function(){return '".site_url($tmu)."/';};console.log('gc object inited');";
