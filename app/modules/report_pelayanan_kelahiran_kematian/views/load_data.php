                ...
                <table id="table_rekap" border="1" class="table table-bordered" width="100%" cellspacing="0">
					...
					?>
                        <tr>
                            ...
                            <td rowspan="3" valign="top" class="list_kelurahan" no_kel="<?=$no_kel?>" periode="<?=$periode?>"><strong><?=$nama_kel?></strong></td>
                            <td>Lahir Baru</td>
                            <td align="center" id="baru_<?=$no_kel?>">0</td>
                        </tr>
                        <tr>
                          <td>Lahir Lama</td>
                            <td align="center" id="lama_<?=$no_kel?>">0</td>
                        </tr>
                        <tr>
                          <td>Kematian</td>
                            <td align="center" id="kematian_<?=$no_kel?>">0</td>
                        </tr>
                        <tr>
