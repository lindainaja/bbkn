...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="100%" align="center"><strong style="font-size:16px"><u>SURAT KETERANGAN DATANG</u></strong></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td width="25%">: {{ detail.kab_asal }}</td>
    ...
    <tr>
        ...
        <td valign="top">: {{ detail.kel_asal }}</td>
    ...
    <tr>
        <td>Status KK Yang Pindah</td>
        <td>: {{ detail.status_kk_yg_pindah }}</td>
    ...
    <tr>
        <td>Tanggal Kepindahan</td>
        <td>: {{ format_tanggal_khusus_indo(detail.tgl_pindah) }}</td>
    ...
    <tr>
        ...
        <td>: {{ format_tanggal_khusus_indo(detail.tgl_datang) }}</td>
