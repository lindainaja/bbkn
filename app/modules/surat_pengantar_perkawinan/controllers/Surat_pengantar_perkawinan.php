<?php 
class Surat_pengantar_perkawinan extends Crud_Controller{
    ...
    {
        $surat_pengantar_perkawinanid = $this->input->post('surat_pengantar_perkawinanid');
        $detail = $this->m_surat_pengantar_perkawinan->detail_data($surat_pengantar_perkawinanid);
        // $detail_data = $this->m_surat_pengantar_perkawinan->detail_data_detail($surat_pengantar_perkawinanid);
            $kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
    $negara        = negara_dropdown();
    $agama       = agama_2_dropdown();
    $pekerjaan   = pekerjaan_dropdown();
