<form class="form-horizontal" action="#" id="form_surat_pengantar_perkawinan">
	<input type="hidden" id="surat_pengantar_perkawinanid" name="surat_pengantar_perkawinanid" value="0" />
...
<h5>Yang Bertanda Tangan</h5>
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="c_nama" name="c_nama" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">NIK <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="c_nik" name="c_nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="50" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Jenis Kelamin <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<label class="radio-inline"><input name="c_jk" class="jk jk_l" checked="" type="radio" value="l" /> Laki-laki</label> 
<label class="radio-inline"><input name="c_jk" class="jk jk_p" type="radio" value="p" /> Perempuan</label> 
</div>
</div>
  <!--   <div class="form-group">
	...
	<input id="c_tempat_lahir" name="c_tempat_lahir" type="text" placeholder="Tempat Lahir" class="wajib_isi form-control" autocomplete="off" />
	</div>
	<div class="col-sm-4 col-lg-3 controls">
	<input id="c_tanggal_lahir" name="c_tanggal_lahir" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" />
	</div>
</div>
    <div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="c_alamat" id="c_alamat" class="wajib_isi form-control" placeholder="Alamat"></textarea>
</div>
</div>
<div class="form-group">
...
<div class="form-group" id="frmJumlahIstri">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="c_jumlah_istri" name="c_jumlah_istri" type="text" placeholder="Jumlah Istri" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group"  id="frmNamaMantan">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="c_nama_mantan" name="c_nama_mantan" type="text" placeholder="Nama Mantan" class="form-control" autocomplete="off"  />
	</div>
</div>
...
<h5>Data Ayah</h5>
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="ayah_nama" name="ayah_nama" type="text" placeholder="Nama Ayah" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="ayah_alias" name="ayah_alias" type="text" placeholder="Alias Ayah" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="ayah_alamat" id="ayah_alamat" class="wajib_isi form-control" placeholder="Tempat Tinggal Ayah "></textarea>
</div>
</div>
<h5>Data Ibu</h5>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="ibu_nama" name="ibu_nama" type="text" placeholder="Nama Ibu" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="ibu_alias" name="ibu_alias" type="text" placeholder="Alias Ibu" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="ibu_alamat" id="ibu_alamat" class="wajib_isi form-control" placeholder="Tempat Tinggal Ibu"></textarea>
</div>
</div>
