...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "Surat Pengantar Perkawinan";
	...
	*/
	...
	protected $_title			= "Laporan Pelayanan Surat Pengantar Perkawinan";
	protected $_keywords		= "laporan simakel Surat Pengantar Perkawinan";
