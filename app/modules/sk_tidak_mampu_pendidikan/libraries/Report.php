...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Pendidikan";
	...
	*/
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:L8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("L8:L{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:L{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_tidak_mampu_pendidikan/libraries/Report.php
