...
class Sk_persetujuan_mempelai extends Crud_Controller
{
    ...
    {
        $sk_persetujuan_mempelaiid = $this->input->post('sk_persetujuan_mempelaiid');
        $detail = $this->m_sk_persetujuan_mempelai->detail_data($sk_persetujuan_mempelaiid);
        // $detail_data = $this->m_sk_persetujuan_mempelai->detail_data_detail($sk_persetujuan_mempelaiid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$negara        = negara_dropdown();
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_persetujuan_mempelai/controllers/Sk_persetujuan_mempelai.php
