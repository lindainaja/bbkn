...
<input type="hidden" id="ikrar_masuk_islamid" name="ikrar_masuk_islamid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="pembimbing" name="pembimbing" type="text" placeholder="Pembimbing" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
{% for i in 1..6 %}
<div class="form-group">
