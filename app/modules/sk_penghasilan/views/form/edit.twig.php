...
<input type="hidden" id="sk_penghasilanid" name="sk_penghasilanid" value="{{ sk_penghasilanid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="surat_bukti" name="surat_bukti" type="text" placeholder="Surat Bukti" class="wajib_isi form-control" autocomplete="off" maxlength="100" value="{{ detail.surat_bukti }}" />
</div>
</div>
<div class="form-group">
