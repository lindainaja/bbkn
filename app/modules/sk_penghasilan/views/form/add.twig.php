<form class="form-horizontal" action="#" id="form_sk_penghasilan">
<input type="hidden" id="sk_penghasilanid" name="sk_penghasilanid" value="0" />
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Surat Bukti <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="surat_bukti" name="surat_bukti" type="text" placeholder="Surat Bukti" class="wajib_isi form-control" autocomplete="off" maxlength="100" />
</div>
</div>
<div class="form-group">
