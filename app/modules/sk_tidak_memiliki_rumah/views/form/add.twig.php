...
<input type="hidden" id="sk_tidak_memiliki_rumahid" name="sk_tidak_memiliki_rumahid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="no_ktp" name="no_ktp" type="text" placeholder="No KTP" class="wajib_isi form-control" autocomplete="off" maxlength="30"   />
</div>
</div>
