<form class="form-horizontal" action="#" id="form_sk_tidak_memiliki_rumah">
<input type="hidden" id="sk_tidak_memiliki_rumahid" name="sk_tidak_memiliki_rumahid" value="{{ sk_tidak_memiliki_rumahid }}" />
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Dusun/Dukuh/Kampung <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="lingkungan" name="lingkungan" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.lingkungan }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">No. KTP <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="no_ktp" name="no_ktp" type="text" placeholder="No KTP" class="wajib_isi form-control" autocomplete="off" maxlength="30" value="{{ detail.no_ktp }}" />
</div>
</div>
