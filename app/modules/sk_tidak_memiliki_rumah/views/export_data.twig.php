...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" colspan="14"><strong style="font-size:21px;">LAPORAN PELAYANAN KELURAHAN {{ nama_bln }}{{ nama_thn }}</strong></td>
    </tr>
</table>
<br/>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td align="center"><strong>Nama Anak</strong></td>
        <td align="center"><strong>Persyaratan Untuk</strong></td>
    </tr>
{% if count_result != 0 %}
...
<tr>
                ...
                <td>{{ result_val.persyaratan_untuk }}</td>
            </tr>
