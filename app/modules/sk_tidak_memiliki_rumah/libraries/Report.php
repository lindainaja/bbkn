...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Surat Permohonan Pertahanan";
	...
	*/
	...
	// 'lg_pk' => 'Yang Diberi Kuasa',

	'nama_2' => 'Nama (Yang Diberi Kuasa)',
	'umur_2' => 'Umur (Yang Diberi Kuasa)',
	'pekerjaan_2' => 'Pekerjaan (Yang Diberi Kuasa)',
	'nomor_ktp_2' => 'Nomor KTP (Yang Diberi Kuasa)',
	'alamat_2' => 'Alamat (Yang Diberi Kuasa)',
	'no_surat_kuasa' => 'Nomor Surat Kuasa',
	'tgl_surat_kuasa' => 'Tanggal Surat Kuasa',
	// 'lg_lt' => 'Lokasi Tanah',
	'jalan' => 'Lokasi Tanah',
	'nomor_hak' => 'Nomor Hak',
	'pengajuan_permohonan' => 'Pengajuan Permohonan',
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:W8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("W8:W{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:W{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_tidak_memiliki_rumah/libraries/Report.php
