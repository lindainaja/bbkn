<form class="form-horizontal" action="#" id="form_sktm">
<input type="hidden" id="sktmid" name="sktmid" value="{{ sktmid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="nik" value="{{ detail.nik }}" name="nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
