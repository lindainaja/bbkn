...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Domisili KK";
	...
	*/
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:N8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("M8:N{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:N{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_domisili_kk/libraries/Report.php
