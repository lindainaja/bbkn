<form class="form-horizontal" action="#" id="form_sk_domisili_kk">
	<input type="hidden" id="sk_domisili_kkid" name="sk_domisili_kkid" value="{{sk_domisili_kkid}}" />
...
<div class="form-group anggota_keluarga">
	...
	<div class="col-sm-3 col-lg-3 controls">
	{{ form_dropdown('detail_jk[]',jenis_kelamin,'','id="detail_jk_1" flag="1" class="select2 form-control" style="width:100%" ') | raw }}
	</div>
	<div class="col-sm-3 col-lg-3 controls">
...
<div class="col-sm-3 col-lg-3 controls">
{{ form_dropdown('detail_jk[]',jenis_kelamin,anggota_val.jk,'id="detail_jk_#{flag}" flag="#{flag}" class="select2 form-control" style="width:100%" ') | raw }}
</div>
<div class="col-sm-3 col-lg-3 controls">
