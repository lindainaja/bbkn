...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Izin Usaha";
	...
	*/
	...
	'luas_tempat_usaha' => 'Luas Tempat Usaha',
	'bidang_usaha' => 'Bidang Usaha',
	'lokasi' => 'Lokasi',
	'lingkungan' => 'Dusun/Dukuh/Kampung',
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:V8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("M8:V{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:V{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_izin_usaha/libraries/Report.php
