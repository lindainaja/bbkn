<form class="form-horizontal" action="#" id="form_sk_izin_usaha">
	<input type="hidden" id="sk_izin_usahaid" name="sk_izin_usahaid" value="0" />
...
<div class="form-group">
	...
	<input id="luas_tempat_usaha" name="luas_tempat_usaha" type="text" placeholder="0.00" class="wajib_isi form-control angka "   autocomplete="off" maxlength="18" />
