...
class Sk_domisili_yayasan extends Crud_Controller
{
    ...
    public function form_tambah_data()
    {
        ...
        $jenis_bangunan = enum_dropdown('sk_domisili_yayasan','jenis_bangunan');
        $lokasi_lingkungan = enum_dropdown('sk_domisili_yayasan','lokasi_lingkungan');
        $status_jenis_luas_bangunan_fasilitas = enum_dropdown('sk_domisili_yayasan','status_jenis_luas_bangunan_fasilitas');
        $status_surat_izin = enum_dropdown('sk_domisili_yayasan','status_surat_izin');
        $status_kabul_permohonan = enum_dropdown('sk_domisili_yayasan','status_kabul_permohonan');
        $status_hasil_skdty = enum_dropdown('sk_domisili_yayasan','status_hasil_skdty');
        $status_hasil_jarak_lingkungan = enum_dropdown('sk_domisili_yayasan','status_hasil_jarak_lingkungan');
        $status_hasil_periksa_fasilitas = enum_dropdown('sk_domisili_yayasan','status_hasil_periksa_fasilitas');
        $data = array(
            ...
            'dropdown_status_hasil_skdty' => form_dropdown('status_hasil_skdty',$status_hasil_skdty,'','id="status_hasil_skdty"  class="wajib_isi select2 form-control" style="width:100%" '),
            ...
            'status_hasil_skdty' => $status_hasil_skdty,
    ...
    public function form_edit_data()
    {
        ...
        $status_hasil_jarak_lingkungan = enum_dropdown('sk_domisili_yayasan','status_hasil_jarak_lingkungan');
        $status_hasil_periksa_fasilitas = enum_dropdown('sk_domisili_yayasan','status_hasil_periksa_fasilitas');
        $sk_domisili_yayasanid = $this->input->post('sk_domisili_yayasanid');
        $detail = $this->m_sk_domisili_yayasan->detail_data($sk_domisili_yayasanid);
        $kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
        ...
        $data = array(
            ...
            'sk_domisili_yayasanid' => $sk_domisili_yayasanid,
            'detail' => $detail,
            ...
            'dropdown_status_hasil_skdty' => form_dropdown('status_hasil_skdty',$status_hasil_skdty,$detail['status_hasil_skdty'],'id="status_hasil_skdty"  class="wajib_isi select2 form-control" style="width:100%" '),
...
}//D:/xampp/htdocs/babakan/app/modules/sk_domisili_yayasan/controllers/Sk_domisili_yayasan.php
