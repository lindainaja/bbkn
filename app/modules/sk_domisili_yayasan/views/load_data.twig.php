...
<table class="table table-striped" id="table_sk_domisili_yayasan" width="100%">
    <thead>
        <tr>
            <th><div align="center">#</div></th>
            <th><div align="center">Tanggal</div></th>
           <th><div align="center">Nama Yayasan</div></th>
            <th><div align="center">Nama Pemilik</div></th> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center">{{ format_datepicker(result_val.date) }}</td>
             ...
             <td align="center">{{ result_val.nama_yayasan }}</td>
