...
<form class="form-horizontal" action="#" id="form_sk_domisili_yayasan">
	<div class="tab-content" style="padding-top: 1em">
		<div id="main" class="tab-pane fade in active">
			<input type="hidden" id="sk_domisili_yayasanid" name="sk_domisili_yayasanid" value="{{ sk_domisili_yayasanid }}" />
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="jabatan" name="jabatan" type="text" placeholder="Jabatan" class="wajib_isi form-control" autocomplete="off" value="{{ detail.jabatan }}" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="no_telp" name="no_telp" type="text" placeholder="No.Tel/HP" class="wajib_isi form-control" autocomplete="off" value="{{ detail.no_telp }}" />
				</div>
			</div>
			<h5>Data Yayasan</h5>
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="nama_yayasan" name="nama_yayasan" type="text" placeholder="Nama Yayasan" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.nama_yayasan }}" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Jenis Kegiatan<span class="require">*</span></label>
				<div class="col-sm-8 col-lg-8 controls">
					<input id="jenis_kegiatan" name="jenis_kegiatan" type="text" placeholder="Jenis Usaha" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.jenis_kegiatan }}" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-5 col-lg-3 controls input-group">
					<input id="jumlah_pengurus" name="jumlah_pengurus" type="text" placeholder="0" class="wajib_isi form-control angka" onkeypress="return blockNonNumbers(this, event, true, true);" autocomplete="off" maxlength="6" value="{{ detail.jumlah_pengurus }}" />
					<span class="input-group-btn">
			...
			<div class="form-group">
				...
				<div class="col-sm-4 col-lg-4 controls">
					<input id="no_yayasan" name="no_yayasan" type="text" placeholder="No. Perusahaan" class="wajib_isi form-control" autocomplete="off" value="{{ detail.no_yayasan }}" />
				</div>
				<div class="col-sm-4 col-lg-3 controls">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<textarea name="alamat_yayasan" id="alamat_yayasan" class="wajib_isi form-control" placeholder="Alamat Yayasan">{{ detail.alamat_yayasan }}</textarea>
				</div>
			</div>
