...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>&nbsp;</td>
        <td>NIK/No Pasport</td>
        <td>:</td>
        <td>{{ detail.nik_pasport }}</td>
    ...
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Benar nama tersebut di atas mempunyai jenis usaha : <strong>"{{ detail.jenis_usaha }}"</strong> yang berlokasi di {{ detail.alamat_usaha }}.</td>
    ...
    <tr>
        <td colspan="4">Dan Surat Keterangan ini berlaku Sejak Tanggal <strong>{{ format_tanggal_khusus_indo(detail.tgl_berlaku_dari) }} s/d {{ format_tanggal_khusus_indo(detail.tgl_berlaku_sampai) }}</strong></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="40%">&nbsp;</td>
        <td width="60%" align="center">{{ detail.nama_kel|upper }}, {{ format_tanggal_khusus_indo(detail.date) }}</td>
