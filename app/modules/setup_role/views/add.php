<form action="<?=site_url($this->func.'/add_process')?>" class="form-horizontal" id="form_tambah" name="form_tambah" method="post">
                ...
                <div class="form-wizard" id="form-wizard-role">
                    <ul class="row steps steps-fill">
                        <li class="col-xs-12 col-sm-6 col-lg-3">
                            ...
                            <span class="desc"><i class="fa fa-check"></i> Role</span>
                            </a>
                        </li>
                        <?php
                        ...
                        <div class="tab-pane active" id="tab2-0">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 col-lg-3 controls">
                                    <input type="text" name="name" id="name" class="form-control" data-rule-required="true"></div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                        <label class="checkbox">
                                            <input type="checkbox" class="menu_2 menu_<?=$menu_2_val['parent_id']?>" name="menu_1[]" id="menu_<?=$menu_2_val['id']?>" parent_id="<?=$menu_2_val['parent_id']?>" value="<?=$menu_2_val['id']?>"> <strong style="font-size:14px"><?=$menu_2_val['name']?></strong>
                                        </label>
                                        <?php
										if(count($menu_3)>0){
										?>
                                            <div class="form-group" style="margin-left: 10px">
                                                ...
                                                ?>
                                                    ...
                                                    <label class="checkbox">
                                                        <input type="checkbox" class="menu_3 menu_<?=$menu_3_val['parent_id']?>" name="menu_1[]" id="menu_<?=$menu_3_val['id']?>" parent_id="<?=$menu_3_val['parent_id']?>" value="<?=$menu_3_val['id']?>"> <strong style="font-size:14px"><?=$menu_3_val['name']?></strong>
                                                    </label>
                                                    ...
                                                    ?>
                                                        <div class="form-group" style="margin-left: 10px">
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <label class="checkbox">
                                                                        <input type="checkbox" name="menu_mechanism_<?=$menu_3_val['id']?>[]" class="menu_mechanism menu_mechanism_<?=$menu_3_val['id']?> <?=$class?>" <?=$attr?> menuid="<?=$menu_3_val['id']?>" value="<?=$mechanism_val['id']?>">&nbsp;&nbsp;&nbsp;<?=$mechanism_val['description']?>
                                                                    </label>
                                                            <?php
                                                                }
                                                            ?>
                                        ...
                                        ?>
                                            <div class="form-group" style="margin-left: 10px">
                                                ...
                                                ?>
                                                        ...
                                                        <label class="checkbox">
                                                            <input type="checkbox" name="menu_mechanism_<?=$menu_2_val['id']?>[]" class="menu_mechanism menu_mechanism_<?=$menu_2_val['id']?> <?=$class?>" <?=$attr?> menuid="<?=$menu_2_val['id']?>" value="<?=$mechanism_val['id']?>">&nbsp;&nbsp;&nbsp;<?=$mechanism_val['description']?>
                                                        </label>
                                                <?php
                                                    }
                                                ?>
                                    ...
                                    ?>
                                        <div class="form-group">
                                            ...
                                            ?>
                                                    ...
                                                    <label class="checkbox">
                                                        <input type="checkbox" name="menu_mechanism_<?=$menu_1_val['id']?>[]" class="menu_mechanism menu_mechanism_<?=$menu_1_val['id']?> <?=$class?>" <?=$attr?> menuid="<?=$menu_1_val['id']?>"  value="<?=$mechanism_val['id']?>">&nbsp;&nbsp;&nbsp;<?=$mechanism_val['description']?>
                                                    </label>
                                            <?php
                                                }
                                            ?>
