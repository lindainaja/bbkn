...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Pas Jalan";
	...
	*/
	...
	'maksud' => 'Maksud',
	'no_ktp' => 'No Ktp',
	'barang_yang_dibawa' => 'Barang Yang Dibawa',
	'lamanya' => 'Lamanya',
	'pengikut' => 'Pengikut',
	...
	protected function setDocumentBody(){
		...
		$rownum = $rownum-1;
		$this->setBorderStyle("V8:V{$rownum}","right");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_pas_jalan/libraries/Report.php
