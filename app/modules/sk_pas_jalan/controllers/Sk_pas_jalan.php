...
class Sk_pas_jalan extends Crud_Controller
{
    ...
    {
        $sk_pas_jalanid = $this->input->post('sk_pas_jalanid');
        $detail = $this->m_sk_pas_jalan->detail_data($sk_pas_jalanid);
        // $detail_data = $this->m_sk_pas_jalan->detail_data_detail($sk_pas_jalanid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
	$negara        = negara_dropdown();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_pas_jalan/controllers/Sk_pas_jalan.php
