...
class Surat_keterangan_lain extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);;
    ...
    {
        $golongan_darah = array(''=>'- - -  Pilih Gol Darah  - - -')+ config_item('gol_darah') + array('Tidak Tahu'=>'Tidak Tahu');
        $surat_keterangan_lainid = $this->input->post('surat_keterangan_lainid');
$detail = $this->m_surat_keterangan_lain->detail_data($surat_keterangan_lainid);
$status_perkawinan	= status_kawin_2_dropdown();
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
...
//D:/xampp/htdocs/babakan/app/modules/surat_keterangan_lain/controllers/Surat_keterangan_lain.php
