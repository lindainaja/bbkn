<form class="form-horizontal" action="#" id="form_surat_keterangan_lain">
	<input type="hidden" id="surat_keterangan_lainid" name="surat_keterangan_lainid" value="0" />
	...
	<!-- <h5>Data Usaha</h5> -->
	<div class="form-group">
		<label class="col-sm-4 col-lg-4 control-label">Perihal <span class="require">*</span></label>
		<div class="col-sm-8 col-lg-7 controls">
		<textarea name="perihal" id="perihal" class="wajib_isi form-control" placeholder="Perihal"></textarea>
		</div>
	</div>
 	<div class="form-group">
