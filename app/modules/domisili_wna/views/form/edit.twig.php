...
<input type="hidden" id="domisili_wnaid" name="domisili_wnaid" value="{{ domisili_wnaid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="no_ket" name="no_ket" type="text" placeholder="Nomor Keterangan" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.no_ket }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">STMD Polres</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="stmd_polres" name="stmd_polres" type="text" placeholder="STMD Polres" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.stmd_polres }}" />
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<input id="visa" name="visa" type="text" placeholder="Visa" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.visa }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Kim.S/ Kim</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="kim" name="kim" type="text" placeholder="Kim.S/ Kim" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.kim }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Izin Kerja (IMTA)</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="izin_kerja" name="izin_kerja" type="text" placeholder="Izin Kerja (IMTA)" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.izin_kerja }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NPWPD</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="npwpd" name="npwpd" type="text" placeholder="NPWPD" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.npwpd }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Maksud Tujuan Kunjungan</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="tujuan_kunjungan" name="tujuan_kunjungan" type="text" placeholder="Maksud Tujuan Kunjungan" class="form-control" autocomplete="off" maxlength="150" value="{{ detail.tujuan_kunjungan }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Tempat Berkunjung Indonesia</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="tempat_kunjungan" name="tempat_kunjungan" type="text" placeholder="Tempat Berkunjung Indonesia" class="form-control" autocomplete="off" maxlength="150" value="{{ detail.tempat_kunjungan }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama Penanggung Jawab</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nama_penanggung_jawab" name="nama_penanggung_jawab" type="text" placeholder="Nama Penanggung Jawab" class="form-control" autocomplete="off" maxlength="150" value="{{ detail.nama_penanggung_jawab }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Alamat Penanggung Jawab</label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_penanggung_jawab" id="alamat_penanggung_jawab" class="form-control" placeholder="Alamat Penanggung Jawab">{{ detail.alamat_penanggung_jawab }}</textarea>
</div>
</div>
<div class="form-group">
