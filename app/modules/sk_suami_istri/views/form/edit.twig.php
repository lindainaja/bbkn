...
<input type="hidden" id="sk_suami_istriid" name="sk_suami_istriid" value="{{ sk_suami_istriid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="keperluan" name="keperluan" value="{{detail.keperluan}}" type="text" placeholder="Keperluan" class="wajib_isi form-control" autocomplete="off" maxlength="100" />
</div>
</div>
<h5>Data Suami</h5>
<div class="form-group">
