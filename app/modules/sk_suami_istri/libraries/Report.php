...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "Surat Keterangan Suami Istri";
	...
	*/
	...
	'no' => 'Nomor Surat',
	'keperluan' => 'Keperluan',
	'perempuan_jenis_kelamin' => 'Jk Perempuan',
	'pria_jenis_kelamin' => 'Jk Pria',
	'perempuan_nama' => 'Nama Perempuan',
	// 'perempuan_tempat_lahir' => 'Tempat Perempuan',
	'perempuan_ttl' => 'Tempat Tgl/Lahir Perempuan',
	'perempuan_kewarganegaraan' => 'Kewarganegaraan Perempuan',
	'perempuan_agama' => 'Agama Perempuan',
	'perempuan_pekerjaan' => 'Pekerjaan Perempuan',
	'perempuan_alamat' => 'Alamat Perempuan',
	'pria_nama' => 'Nama Pria',
	// 'pria_tempat_lahir' => ' Pria',
	'pria_ttl' => 'Tempat Tanggal/Lahir Pria',
	'pria_kewarganegaraan' => 'Kewarganegaraan Pria',
	'pria_agama' => 'Agama Pria',
	'pria_pekerjaan' => 'Pekerjaan Pria',
	'pria_alamat' => 'Alamat Pria',
];
	...
	protected function modifyRowData($row){
		if(!is_array($row)){
         ...
         $ret = $row;
            ...
            $ret['pria_tanggal_lahir']  = format_tanggal_khusus_indo($row['pria_tanggal_lahir']);
            $ret['perempuan_tanggal_lahir']  = format_tanggal_khusus_indo($row['perempuan_tanggal_lahir']);
            $ret['pria_jenis_kelamin']  = $gender[$ret['pria_jk']];
            $ret['perempuan_jenis_kelamin']  = $gender[$ret['perempuan_jk']];



            $ret['tanggal_surat']  = format_tanggal_khusus_indo($row['date']);
            // $ret['tanggal_hilang'] = format_tanggal_khusus_indo($row['tgl_hilang']);
            $ret['pria_ttl'] = $row['pria_tempat_lahir'] . ', '. $ret['pria_tanggal_lahir'];
            $ret['perempuan_ttl'] = $row['perempuan_tempat_lahir'] . ', ' .$ret['perempuan_tanggal_lahir'];

           return $ret;
	}
	
}//D:/xampp/htdocs/babakan/app/modules/sk_suami_istri/libraries/Report.php
