...
class Sk_suami_istri extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_suami_istriid = $this->input->post('sk_suami_istriid');
$detail = $this->m_sk_suami_istri->detail_data($sk_suami_istriid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
$data = array(
	...
	'sk_suami_istriid' => $sk_suami_istriid,
	'detail' => $detail,
	'negara' => $negara,
	'agama' => $agama,
	'pekerjaan' => $pekerjaan,
...
//D:/xampp/htdocs/babakan/app/modules/sk_suami_istri/controllers/Sk_suami_istri.php
