...
<input type="hidden" id="sk_kehilanganid" name="sk_kehilanganid" value="0" />
...
<div class="col-sm-4 col-lg-3 controls">
<input id="tanggal_kehilangan" name="tanggal_kehilangan" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Kehilangan di <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="kehilangan_di" name="kehilangan_di" type="text" placeholder="Kehilangan di" class="wajib_isi form-control" autocomplete="off" maxlength="250" />
</div>
</div>
