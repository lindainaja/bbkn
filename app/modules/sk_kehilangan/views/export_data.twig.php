...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td align="center"><strong>Tanggal Kehilangan</strong></td>
        <td align="center"><strong>Lokasi Kehilangan</strong></td>
    </tr>
{% if count_result != 0 %}
...
<tr>
                ...
                <td>{{ format_tanggal(result_val.tanggal_kehilangan) }}</td>
