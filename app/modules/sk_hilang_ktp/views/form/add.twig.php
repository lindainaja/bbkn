<form class="form-horizontal" action="#" id="form_sk_hilang_ktp">
	<input type="hidden" id="sk_hilang_ktpid" name="sk_hilang_ktpid" value="0" />
...
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="no_kk_ktp" name="no_kk_ktp" type="text" placeholder="Nomor KK/KTP" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
