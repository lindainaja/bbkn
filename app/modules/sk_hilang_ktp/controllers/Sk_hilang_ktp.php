...
class Sk_hilang_ktp extends Crud_Controller
{
    ...
    {
        $sk_hilang_ktpid = $this->input->post('sk_hilang_ktpid');
        $detail = $this->m_sk_hilang_ktp->detail_data($sk_hilang_ktpid);
        // $detail_data = $this->m_sk_hilang_ktp->detail_data_detail($sk_hilang_ktpid);
        // $negara		 	= negara_dropdown();
        $agama 			= agama_2_dropdown();
        $pekerjaan	 	= pekerjaan_dropdown();
        $kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
            ...
            $ret['nama_barang'] = ' KTP (Kartu Tanda Penduduk) ';
...
}//D:/xampp/htdocs/babakan/app/modules/sk_hilang_ktp/controllers/Sk_hilang_ktp.php
