...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="100%" align="center"><strong style="font-size:21px"><u>SURAT KETERANGAN NUMPANG NIKAH</u></strong></td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center">Surat Keterangan ini diberikan Kepada :</td>
    </tr>
</table>
<br/>
<br/>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>&nbsp;</td>
        <td valign="top">Maksud/Tujuan</td>
        <td valign="top">:</td>
        <td valign="top">Hendak Nikah dengan seorang {{ detail.jk == 'l' ? '<strong>Perempuan</strong>' : '<strong>Laki-laki</strong>' }}</td>
    ...
    <tr>
        ...
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
        <td valign="top">Nama : <strong>{{ detail.nama_calon }}</strong></td>

    </tr>
    <tr>
        <td>&nbsp;</td>
        <td valign="top">Penduduk</td>
        <td valign="top">:</td>
        <td valign="top">{{ nl2br(detail.alamat)|raw }}</td>
