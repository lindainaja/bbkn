...
<input type="hidden" id="sk_numpang_nikahid" name="sk_numpang_nikahid" value="{{ sk_numpang_nikahid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="nama_calon" name="nama_calon" type="text" placeholder="Nama Calon" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.nama_calon }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Alamat Calon <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_calon" id="alamat_calon" class="wajib_isi form-control" placeholder="Alamat Calon">{{ detail.alamat_calon }}</textarea>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="keterangan_{{ i }}" id="keterangan_{{ i }}" class="form-control" placeholder="Keterangan">{{ detail[keterangan_key] }}</textarea>
</div>
</div>
{% endfor %}
