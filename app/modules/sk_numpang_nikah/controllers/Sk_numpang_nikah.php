...
class Sk_numpang_nikah extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_numpang_nikahid = $this->input->post('sk_numpang_nikahid');
$detail = $this->m_sk_numpang_nikah->detail_data($sk_numpang_nikahid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
//D:/xampp/htdocs/babakan/app/modules/sk_numpang_nikah/controllers/Sk_numpang_nikah.php
