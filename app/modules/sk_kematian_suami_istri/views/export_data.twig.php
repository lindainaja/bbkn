...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" colspan="22"><strong style="font-size:21px;">LAPORAN PELAYANAN KELURAHAN {{ nama_bln }}{{ nama_thn }}</strong></td>
    </tr>
</table>
<br/>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td colspan="8" align="center"><strong>Data yang masih hidup</strong></td>
      <td colspan="10" align="center"><strong>Data yang sudah meninggal</strong></td>
    </tr>
    <tr>
        ...
        <td align="center"><strong>Pekerjaan</strong></td>
        <td align="center"><strong>Alamat</strong></td>
        <td align="center"><strong>Tanggal Meninggal</strong></td>
        <td align="center"><strong>Meniggal di</strong></td>
        <td align="center"><strong>Sebab Meninggal</strong></td>
    </tr>
{% if count_result != 0 %}
...
<tr>
                ...
                <td>{{ result_val.meninggal_tempat_lahir }}</td>
                <td>{{ format_tanggal(result_val.meninggal_tanggal_lahir) }}</td>
                <td>{{ result_val.meninggal_kewarganegaraan }}</td>
                <td>{{ result_val.meninggal_agama }}</td>
                <td>{{ result_val.meninggal_pekerjaan }}</td>
                <td>{{ result_val.meninggal_alamat }}</td>
                <td>{{ format_tanggal(result_val.tanggal_meninggal) }}</td>
                <td>{{ result_val.tempat_meninggal }}</td>
                <td>{{ result_val.sebab_meninggal }}</td>
            </tr>
