...
<table class="table table-striped" id="table___T_MODULE__" width="100%">
    <thead>
        <tr>
...
<th><div align="center">Nama Usaha</div></th>
<th><div align="center">Berlaku Sampai</div></th>
...
<td>{{ result_val.nama_usaha }}</td>
<td>{{ format_datepicker(result_val.berlaku_sampai) }}</td>
