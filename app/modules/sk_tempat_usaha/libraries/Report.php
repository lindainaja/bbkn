...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Tempat Usaha";
	...
	*/
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:R8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("R8:R{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:R{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_tempat_usaha/libraries/Report.php
