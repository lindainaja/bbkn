<form class="form-horizontal" action="#" id="form_sk_hilang_kk">
	<input type="hidden" id="sk_hilang_kkid" name="sk_hilang_kkid" value="{{sk_hilang_kkid}}" />
...
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Tanggal Hilang 
	<span class="require">*</span>
			</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="tgl_hilang" name="tgl_hilang" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" value="{{format_datepicker(detail.tgl_hilang)}}"  />
</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="col-sm-4 col-lg-3 control-label">Nomor KK 
		<span class="require">*</span>
				</label>
	<div class="col-sm-8 col-lg-7 controls">
		<input id="no_kk" name="no_kk" type="text" placeholder="Nomor KK" class="wajib_isi form-control" autocomplete="off"  value="{{detail.no_kk}}" />
	</div>
</div>
