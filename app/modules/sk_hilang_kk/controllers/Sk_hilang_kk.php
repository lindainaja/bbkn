...
class Sk_hilang_kk extends Crud_Controller
{
    ...
    {
        $sk_hilang_kkid = $this->input->post('sk_hilang_kkid');
        $detail = $this->m_sk_hilang_kk->detail_data($sk_hilang_kkid);
        // $detail_data = $this->m_sk_hilang_kk->detail_data_detail($sk_hilang_kkid);
        // $negara		 	= negara_dropdown();
        $agama 			= agama_2_dropdown();
        $pekerjaan	 	= pekerjaan_dropdown();
        $kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
}//D:/xampp/htdocs/babakan/app/modules/sk_hilang_kk/controllers/Sk_hilang_kk.php
