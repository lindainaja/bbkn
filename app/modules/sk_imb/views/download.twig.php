...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Yang bertanda tangan dibawah ini Lurah {{ detail.nama_kel|upper }} Kecamatan {{ detail.nama_kec|upper }} {{ detail.nama_kab|upper }}, dengan ini  Memberikan Rekomendasi Kepada :</td>
    ...
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dengan ini menerangkan dan berdasarkan laporan dari RT dan RW nya ,benar nama tersebut diatas akan merenofasi Bangunan Tempat Tinggal yang berlokasi di {{ detail.alamat }}, dengan rincian ukuran dan struktur Bangunan Sebagai berikut : </strong></td>
    ...
    <tr>
        ...
        <td valign="top">:</td>
        <td valign="top">Panjang {{ format_uang(detail.panjang) }} M, Lebar {{ format_uang(detail.lebar) }} M</td>

    </tr>
    <tr>
        <td>&nbsp;</td>
        <td valign="top">Jumlah Lantai</td>
        <td valign="top">:</td>
        <td valign="top">{{ detail.jml_lantai }} Lantai</td>

    </tr>
    <tr>
        <td>&nbsp;</td>
        <td valign="top">Luas teras</td>
        <td valign="top">:</td>
        {% set luas_teras=format_uang(detail.luas_teras) %}
        {% set luas_teras="#{luas_teras} M<sup>2</sup>" %}
        <td valign="top">{{ detail.luas_teras ? luas_teras|raw : '' }}</td>
    ...
    <tr>
        <td colspan="4">Dengan Rincian Struktur Bangunan sebagai berikut :</td>
    </tr>
    <tr>
        <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td valign="top">Pondasi</td>
        <td valign="top">:</td>
        <td valign="top">{{ detail.pondasi }}</td>
    ...
    <tr>
        ...
        <td valign="top">:</td>
        <td valign="top">{{ detail.dinding }}</td>
    ...
    <tr>
        ...
        <td valign="top">:</td>
        <td valign="top">{{ detail.lantai }}</td>
    ...
    <tr>
      <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Demikian surat Keterangan  ini kami berikan sebagai Rekomendasi pada instansi terkait dan kepada yang berkepentingan agar menjadi bahan periksa.</td>
    </tr>
</table>
<br/><br/>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
