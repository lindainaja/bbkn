...
class Sk_tidak_mampu extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_tidak_mampuid = $this->input->post('sk_tidak_mampuid');
$detail = $this->m_sk_tidak_mampu->detail_data($sk_tidak_mampuid);
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
$data = array(
...
//D:/xampp/htdocs/babakan/app/modules/sk_tidak_mampu/controllers/Sk_tidak_mampu.php
