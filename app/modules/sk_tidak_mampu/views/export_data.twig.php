...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td colspan="6" align="center"><strong>Data Orang Tua</strong></td>
      <td colspan="6" align="center"><strong>Data Anak</strong></td>
    </tr>
    <tr>
...
<tr>
                ...
                <td>{{ result_val.anak_nama }}</td>
                <td>{{ result_val.anak_tempat_lahir }}</td>
                <td>{{ format_tanggal(result_val.anak_tanggal_lahir) }}</td>
                <td>{{ result_val.anak_agama }}</td>
                <td>{{ result_val.anak_pekerjaan }}</td>
                <td>{{ result_val.anak_alamat }}</td>
            </tr>
