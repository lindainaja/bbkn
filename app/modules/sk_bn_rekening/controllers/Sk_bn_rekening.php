...
class Sk_bn_rekening extends Crud_Controller
{
	...
	$agama       = agama_2_dropdown();
        ...
        $data = array(
            	...
            	'dropdown_status_perkawinan_2' => form_dropdown('status_perkawinan_2',$status_perkawinan,'','id="status_perkawinan_2" class="wajib_isi select2 form-control" style="width:100%" '),
            	'dropdown_pekerjaan_2' => form_dropdown('pekerjaan_2',$pekerjaan,'','id="pekerjaan_2" class="wajib_isi select2 form-control" style="width:100%" '),
            	'dropdown_agama_2' => form_dropdown('agama_2',$agama,'','id="agama_2" class="wajib_isi select2 form-control" style="width:100%" '),
    ...
    {
        $sk_bn_rekeningid = $this->input->post('sk_bn_rekeningid');
        $detail = $this->m_sk_bn_rekening->detail_data($sk_bn_rekeningid);
        // $detail_data = $this->m_sk_bn_rekening->detail_data_detail($sk_bn_rekeningid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$status_perkawinan  = status_kawin_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
	$agama       = agama_2_dropdown();
        ...
        $data = array(
            	...
            	'dropdown_status_perkawinan_2' => form_dropdown('status_perkawinan_2',$status_perkawinan,$detail['status_perkawinan_2'],'id="status_perkawinan" class="wajib_isi select2 form-control" style="width:100%" '),
            	'dropdown_pekerjaan_2' => form_dropdown('pekerjaan_2',$pekerjaan,$detail['pekerjaan_2'],'id="pekerjaan_2" class="wajib_isi select2 form-control" style="width:100%" '),
            	'dropdown_agama_2' => form_dropdown('agama_2',$agama,$detail['agama_2'],'id="agama_2" class="wajib_isi select2 form-control" style="width:100%" '),

        	'sk_bn_rekeningid' => $sk_bn_rekeningid,
        	'detail' => $detail,
...
}//D:/xampp/htdocs/babakan/app/modules/sk_bn_rekening/controllers/Sk_bn_rekening.php
