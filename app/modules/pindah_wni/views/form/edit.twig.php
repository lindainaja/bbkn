...
<input type="hidden" id="pindah_wniid" name="pindah_wniid" value="{{ pindah_wniid }}" />
...
<div class="col-sm-6 col-lg-5 controls">
<input value="{{detail.kampung_asal}}" id="kampung_asal" name="kampung_asal" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" maxlength="50" />
</div>
</div>
...
<div class="col-sm-6 col-lg-5 controls">
<input id="dusun_pindah" name="dusun_pindah" type="text" placeholder="" class="form-control" autocomplete="off" maxlength="200" value="{{ detail.dusun_pindah }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-3 col-lg-3 control-label">Kodepos </label>
