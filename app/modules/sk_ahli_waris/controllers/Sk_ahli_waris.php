...
class Sk_ahli_waris extends Crud_Controller
{
    ...
    {
        $sk_ahli_warisid = $this->input->post('sk_ahli_warisid');
        $detail = $this->m_sk_ahli_waris->detail_data($sk_ahli_warisid);
        // $detail_data = $this->m_sk_ahli_waris->detail_data_detail($sk_ahli_warisid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
	$status_perkawinan  = status_kawin_2_dropdown();
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
          ...
          $camat = $this->m_sk_ahli_waris->get_camat();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_ahli_waris/controllers/Sk_ahli_waris.php
