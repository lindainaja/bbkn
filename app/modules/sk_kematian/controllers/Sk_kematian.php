...
class Sk_kematian extends Crud_Controller
{
    ...
    {
        $sk_kematianid = $this->input->post('sk_kematianid');
        $detail = $this->m_sk_kematian->detail_data($sk_kematianid);
        // $detail_data = $this->m_sk_kematian->detail_data_detail($sk_kematianid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
}//D:/xampp/htdocs/babakan/app/modules/sk_kematian/controllers/Sk_kematian.php
