...
<table class="table table-striped" id="table_sk_kematian" width="100%">
    <thead>
        <tr>
...
<th><div align="center">Nama Pelapor</div></th> 
...
<td>{{ format_datepicker(result_val.tanggal_meninggal) }}</td> 
<td>{{ result_val.nama_pelapor }}</td>
