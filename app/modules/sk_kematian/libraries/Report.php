...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Kematian";
	...
	*/
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:M8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("M8:M{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:M{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_kematian/libraries/Report.php
