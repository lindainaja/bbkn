...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td>:</td>
        <td>{{ detail.status_perkawinan|upper }}</td>
    ...
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nama tersebut adalah  Penduduk/Warga yang bertempat Tinggal di Wilayah Kami Kelurahan {{ detail.nama_kel|upper }}, hal ini berdasarkan Penelitian dan Laporan RT/RW setempat.</td>
    ...
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dan surat Keterangan ini berlaku mulai Tanggal <strong>{{ format_tanggal_khusus_indo(detail.tgl_berlaku_dari) }} s/d {{ format_tanggal_khusus_indo(detail.tgl_berlaku_sampai) }}</strong></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>&nbsp;</td>
        <td rowspan="5" style="border:1px solid #000">&nbsp;</td>
