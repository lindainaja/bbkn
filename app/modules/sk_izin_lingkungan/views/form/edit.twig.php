...
<input type="hidden" id="sk_izin_lingkunganid" name="sk_izin_lingkunganid" value="{{ sk_izin_lingkunganid }}" />
...
<div class="form-group">
	...
	<div class="col-sm-4 col-lg-4 controls">
		<input id="btd_1" name="btd_1" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_1 }}" />
	</div>
	<div class="col-sm-3 col-lg-3 controls">
		<input id="btd_1_jabatan" name="btd_1_jabatan" type="text" placeholder="Jabatan" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_1_jabatan }}" />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-4 col-lg-4 control-label">2. <span class="require">*</span></label>
	<div class="col-sm-4 col-lg-4 controls">
		<input id="btd_2" name="btd_2" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_2 }}" />
	</div>
	<div class="col-sm-3 col-lg-3 controls">
		<input id="btd_2_jabatan" name="btd_2_jabatan" type="text" placeholder="Jabatan" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_2_jabatan }}" />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-4 col-lg-4 control-label">3. <span class="require"></span></label>
	<div class="col-sm-4 col-lg-4 controls">
		<input id="btd_3" name="btd_3" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_3 }}" />
	</div>
	<div class="col-sm-3 col-lg-3 controls">
		<input id="btd_3_jabatan" name="btd_3_jabatan" type="text" placeholder="Jabatan" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_3_jabatan }}" />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-4 col-lg-4 control-label">4. <span class="require"></span></label>
	<div class="col-sm-4 col-lg-4 controls">
		<input id="btd_4" name="btd_4" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_4 }}" />
	</div>
	<div class="col-sm-3 col-lg-3 controls">
		<input id="btd_4_jabatan" name="btd_4_jabatan" type="text" placeholder="Jabatan" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_4_jabatan }}" />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-4 col-lg-4 control-label">5. <span class="require"></span></label>
	<div class="col-sm-4 col-lg-4 controls">
		<input id="btd_5" name="btd_5" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_5 }}" />
	</div>
	<div class="col-sm-3 col-lg-3 controls">
		<input id="btd_5_jabatan" name="btd_5_jabatan" type="text" placeholder="Jabatan" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.btd_5_jabatan }}" />
	</div>
</div>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="jenis_kegiatan" name="jenis_kegiatan" type="text" placeholder="Jenis Kegiatan" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.jenis_kegiatan }}" />
</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-4 col-lg-3 controls">
		<input id="tgl_acara" name="tgl_acara" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" value="{{ format_datepicker(detail.tgl_acara) }}" />
	</div>
	<div class="col-sm-4 col-lg-4 controls">
<input id="hari_acara_ext" name="hari_acara_ext" type="text" placeholder="Ext Hari" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.hari_acara_ext }}" />
</div>
</div>
<div class="form-group">
...
<input class="form-control timepicker-24" name="jam_acara" id="jam_acara" type="text" placeholder="H:i" value="{{ detail.jam_acara }}" >
</div>
...
<!-- <span>Selesai</span> -->
<!-- <input class="form-control timepicker-24" name="jam_acara_selesai" id="jam_acara_selesai" type="text" placeholder="H:i" value="{{ detail.jam_acara_selesai }}" > -->
</div>
</div>
<div class="form-group">
