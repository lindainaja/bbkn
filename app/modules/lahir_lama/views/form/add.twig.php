...
<input type="hidden" id="lahir_lamaid" name="lahir_lamaid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="nama" name="nama" type="text" placeholder="Nama kecil Kel " class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama dewasa Kel</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nama_dewasa" name="nama_dewasa" type="text" placeholder="Nama" class="form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<label class="radio-inline"><input name="jenis_kelahiran" class="jenis_kelahiran jenis_kelahiran_tunggal" checked="" type="radio" value="Tunggal" /> Tunggal</label> 
<label class="radio-inline"><input name="jenis_kelahiran" class="jenis_kelahiran jenis_kelahiran_kembar" type="radio" value="Kembar" /> Kembar</label> 
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Alamat dilahirkan <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_kelahiran" id="alamat_kelahiran" class="wajib_isi form-control" placeholder="Alamat dilahirkan"></textarea>
</div>
</div>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="ibu_nama" name="ibu_nama" type="text" placeholder="Nama Ibu" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<input id="ayah_nama" name="ayah_nama" type="text" placeholder="Nama Ayah" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Umur <span class="require">*</span></label>
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_ortu" id="alamat_ortu" class="wajib_isi form-control" placeholder="Alamat"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Kelahiran Ke <span class="require">*</span></label>
<div class="col-sm-2 col-lg-2 controls">
<input id="kelahiran_ke" name="kelahiran_ke" type="text" placeholder="Ke" class="wajib_isi form-control" autocomplete="off" maxlength="2" onkeypress="return blockNonNumbers(this, event, true, true);" />
</div>
</div>
