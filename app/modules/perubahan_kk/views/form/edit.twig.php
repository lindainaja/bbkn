...
<input type="hidden" id="perubahan_kkid" name="perubahan_kkid" value="{{ perubahan_kkid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="nama_kk" name="nama_kk" type="text" placeholder="Nama KK" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.nama_kk }}" />
</div>
</div>
<div class="form-group">
...
<input id="rt" name="rt" type="text" placeholder="RT" class="wajib_isi form-control" autocomplete="off" maxlength="5" value="{{ detail.rt }}" />
</div>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="nama_kk_lama" name="nama_kk_lama" type="text" placeholder="Nama KK Lama" class="form-control" autocomplete="off" maxlength="150" value="{{ detail.nama_kk_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">No KK Lama</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="no_kk_lama" name="no_kk_lama" type="text" placeholder="No KK Lama" class="form-control" autocomplete="off" maxlength="25" value="{{ detail.no_kk_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Alamat Lama</label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_lama" id="alamat_lama" class="form-control" placeholder="Alamat Lama">{{ detail.alamat_lama }}</textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">RT Lama</label>
<div class="col-sm-2 col-lg-2 controls">
<input id="rt_lama" name="rt_lama" type="text" placeholder="RT Lama" class="form-control" autocomplete="off" maxlength="5" value="{{ detail.rt_lama }}" />
</div>
<label class="col-sm-2 col-lg-2 control-label">RW Lama</label>
<div class="col-sm-2 col-lg-2 controls">
<input id="rw_lama" name="rw_lama" type="text" placeholder="RW Lama" class="form-control" autocomplete="off" maxlength="5" value="{{ detail.rw_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Desa/Kelurahan Lama</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="kel_lama" name="kel_lama" type="text" placeholder="Desa/Kelurahan Lama" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.kel_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Kecamatan Lama</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="kec_lama" name="kec_lama" type="text" placeholder="Kecamatan Lama" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.kec_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Kota/Kabupaten Lama</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="kab_lama" name="kab_lama" type="text" placeholder="Kota/Kabupaten Lama" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.kab_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Provinsi Lama</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="prop_lama" name="prop_lama" type="text" placeholder="Provinsi Lama" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.prop_lama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Kode Pos Lama</label>
<div class="col-sm-2 col-lg-2 controls">
<input id="kodepos_lama" name="kodepos_lama" type="text" placeholder="Kode Pos Lama" class="form-control" autocomplete="off" maxlength="7" value="{{ detail.kodepos_lama }}" />
</div>
<label class="col-sm-2 col-lg-2 control-label">Telpon Lama</label>
<div class="col-sm-2 col-lg-3 controls">
<input id="tlp_lama" name="tlp_lama" type="text" placeholder="Telpon Lama" class="form-control" autocomplete="off" maxlength="25" value="{{ detail.tlp_lama }}" />
</div>
</div>
<hr/>
<div class="form-group">
