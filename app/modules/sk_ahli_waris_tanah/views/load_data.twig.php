...
<table class="table table-striped" id="table_sk_ahli_waris_tanah" width="100%">
    <thead>
        <tr>
...
<th><div align="center">Nama Almarhum</div></th>
<th><div align="center">Nama Pasangan Alm.</div></th>
...
<td>{{ result_val.nama_almarhum }}</td>
<td>{{ result_val.nama_pasangan_almarhum }}</td>
