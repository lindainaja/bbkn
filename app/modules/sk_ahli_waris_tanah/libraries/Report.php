...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Ahli Waris Tanah";
	...
	*/
	...
	'nama_pasangan_almarhum' => 'Nama Pasangan Alm.',
	'no_sertifikat' => 'No Sertifikat',
	'tanggal_meninggal' => 'Tanggal Meninggal',
	'no_surat_kematian' => 'No Surat Kematian',
	// 'aw1_legend' => 'Data Ahli Waris 1',
	'aw1_nama' => 'Nama',
	'aw1_status' => 'Status Keluarga',
	'aw1_pekerjaan' => 'Pekerjaan',
	'aw1_alamat' => 'Alamat',
	// 'aw2_legend' => 'Data Ahli Waris 2',
	'aw2_nama' => 'Nama',
	'aw2_status' => 'Status Keluarga',
	'aw2_pekerjaan' => 'Pekerjaan',
	'aw2_alamat' => 'Alamat',
	// 'aw3_legend' => 'Data Ahli Waris 3',
	'aw3_nama' => 'Nama',
	'aw3_status' => 'Status Keluarga',
	'aw3_pekerjaan' => 'Pekerjaan',
	'aw3_alamat' => 'Alamat',
	// 'aw4_legend' => 'Data Ahli Waris 4',
	'aw4_nama' => 'Nama',
	'aw4_status' => 'Status Keluarga',
	'aw4_pekerjaan' => 'Pekerjaan',
	'aw4_alamat' => 'Alamat',
	// 'sak_legend' => 'Data Saksi',
	'saksi_1' => 'Nama Saksi 1',
	'saksi_2' => 'Nama Saksi 2', 
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:AC8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("AC8:AC{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:AC{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_ahli_waris_tanah/libraries/Report.php
