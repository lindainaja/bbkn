...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Domisili Kantor";
	...
	*/
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:K8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("K8:K{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:K{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/sk_domisili_kantor/libraries/Report.php
