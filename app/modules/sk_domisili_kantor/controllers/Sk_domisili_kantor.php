...
class Sk_domisili_kantor extends Crud_Controller
{
    ...
    {
        $sk_domisili_kantorid = $this->input->post('sk_domisili_kantorid');
        $detail = $this->m_sk_domisili_kantor->detail_data($sk_domisili_kantorid);
        // $detail_data = $this->m_sk_domisili_kantor->detail_data_detail($sk_domisili_kantorid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
}//D:/xampp/htdocs/babakan/app/modules/sk_domisili_kantor/controllers/Sk_domisili_kantor.php
