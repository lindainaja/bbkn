<form class="form-horizontal" action="#" id="form_sk_domisili_kantor">
	<input type="hidden" id="sk_domisili_kantorid" name="sk_domisili_kantorid" value="0" />
...
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="domisili" name="domisili" type="text" placeholder="Domisili" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="nama_ketua" name="nama_ketua" type="text" placeholder="Nama Ketua" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_ketua" id="alamat_ketua" class="wajib_isi form-control" placeholder="Alamat Ketua"></textarea>
</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="nama_organisasi" name="nama_organisasi" type="text" placeholder="Nama Organisasi" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_kantor" id="alamat_kantor" class="wajib_isi form-control" placeholder="Alamat Kantor"></textarea>
</div>
</div>
<div class="form-group">
