...
<table class="table table-striped" id="table_sk_domisili_kantor" width="100%">
    <thead>
        <tr>
            <th><div align="center">#</div></th>
            <th><div align="center">Tanggal</div></th>
           <th><div align="center">Nama Organisasi</div></th>
            <th><div align="center">Nama Ketua</div></th> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center">{{ format_datepicker(result_val.date) }}</td>
             ...
             <td align="center">{{ result_val.nama_ketua }}</td>

            <td>{{ result_val.nama_organisasi }}</td> 
