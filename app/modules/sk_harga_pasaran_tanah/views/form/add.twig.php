...
<input type="hidden" id="sk_harga_pasaran_tanahid" name="sk_harga_pasaran_tanahid" value="0" />
...
<input  id="luas_tanah" name="luas_tanah" type="text" placeholder="Luas Tanah" class="wajib_isi form-control" autocomplete="off" maxlength=11 onkeypress="return blockNonNumbers(this, event, true, true);" />
...
<div class="col-sm-4 col-lg-3 controls">
<input id="harga_tanah" name="harga_tanah" type="text" placeholder="0" class="wajib_isi form-control angka" autocomplete="off" maxlength="18" onkeypress="return blockNonNumbers(this, event, true, true);" />
</div>
</div>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="no_shm" name="no_shm" type="text" placeholder="No. SHM" class="wajib_isi form-control" autocomplete="off" maxlength="100"  />
</div>
</div>
