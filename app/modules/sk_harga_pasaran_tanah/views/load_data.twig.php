...
<table class="table table-striped" id="table_sk_harga_pasaran_tanah" width="100%">
    <thead>
        <tr>
            ...
            <th><div align="center">Harga Tanah</div></th>
...
{% if count_result != 0 %}
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="right">{{  result_val.luas_tanah }} M<sup>2</sup></td>

            <td align="right">{{ format_uang(result_val.harga_tanah) }}</td>
