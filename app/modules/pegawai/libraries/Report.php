...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "Pegawai";
	...
	*/
	...
	protected $_title			= "Laporan Data Pegawai";
...
'status_pegawai' => 'Status Pegawai',
	...
	protected function setDocumentBody(){
		...
		$subtitle 				= __T( "LAPORAN DATA PEGAWAI KELURAHAN {{nama_bln}} {{nama_thn}}", $this->data );
	...
	protected function modifyRowData($row){
        ...
        $ret['nama_pegawai'] = $row['gelar_nonakademis'].' '.$row['gelar_depan'] . ' ' . $row['nama_pegawai'] . ' ' . $row['gelar_belakang'];
        $ret['ttl'] = $row['tempat_lahir'] . ", ".$ret['tanggal_lahir'];

	    return $ret;
	}
	
}//D:/xampp/htdocs/babakan/app/modules/pegawai/libraries/Report.php
