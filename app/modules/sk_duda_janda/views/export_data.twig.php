...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" colspan="19"><strong style="font-size:21px;">LAPORAN PELAYANAN KELURAHAN {{ nama_bln }}{{ nama_thn }}</strong></td>
    </tr>
</table>
<br/>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td colspan="8" align="center"><strong>PIHAK I</strong></td>
      <td colspan="7" align="center"><strong>PIHAK II</strong></td>
    </tr>
    <tr>
...
<tr>
                ...
                <td>{{ result_val.dari_nama }}</td>
                <td>{{ result_val.dari_tempat_lahir }}</td>
                <td>{{ format_tanggal(result_val.dari_tanggal_lahir) }}</td>
                <td>{{ result_val.dari_kewarganegaraan }}</td>
                <td>{{ result_val.dari_agama }}</td>
                <td>{{ result_val.dari_pekerjaan }}</td>
                <td>{{ result_val.dari_alamat }}</td>
            </tr>
