<form class="form-horizontal" action="#" id="form_sk_kelakuan_baik">
<input type="hidden" id="sk_kelakuan_baikid" name="sk_kelakuan_baikid" value="{{ sk_kelakuan_baikid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="keperluan" name="keperluan" type="text" placeholder="Nama Keperluan" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.keperluan }}" />
</div>
</div>
