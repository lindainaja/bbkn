...
<input type="hidden" id="sk_kelakuan_baikid" name="sk_kelakuan_baikid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="keperluan" name="keperluan" type="text" placeholder="Nama Keperluan" class="wajib_isi form-control" autocomplete="off" maxlength="250" />
</div>
</div>
<!-- <h5>Data Kapolsek</h5>
<div class="form-group">
