...
class sk_kelakuan_baik extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_kelakuan_baikid = $this->input->post('sk_kelakuan_baikid');
$detail = $this->m_sk_kelakuan_baik->detail_data($sk_kelakuan_baikid);
$status_perkawinan 	= status_kawin_2_dropdown();
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
...
$this->twig->display('form/edit.twig.php',$data);
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
            ...
            $is_lurah = preg_match('/lurah/i',$ret['ttd_jabatan']);
            $ret['atas_nama']  = !$is_lurah ? 'a.n. ':'';
            $ret['ttd_jabatan'] = !$is_lurah ? config_item('default_ttd_jabatan') :  $ret['ttd_jabatan'];
            // $ret['tgl_nopol']  = format_tanggal_khusus_indo($row['tgl_nopol']);
...
//D:/xampp/htdocs/babakan/app/modules/sk_kelakuan_baik/controllers/Sk_kelakuan_baik.php
