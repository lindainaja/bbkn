...
class Sk_penghasilan_lainya extends Crud_Controller
{
    ...
    {
        $sk_penghasilan_lainyaid = $this->input->post('sk_penghasilan_lainyaid');
        $detail = $this->m_sk_penghasilan_lainya->detail_data($sk_penghasilan_lainyaid);
        // $detail_data = $this->m_sk_penghasilan_lainya->detail_data_detail($sk_penghasilan_lainyaid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
	$status_perkawinan  = status_kawin_2_dropdown();
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
            ...
            $ret['penghasilan_txt'] = convert_number($ret['penghasilan']);
...
}//D:/xampp/htdocs/babakan/app/modules/sk_penghasilan_lainya/controllers/Sk_penghasilan_lainya.php
