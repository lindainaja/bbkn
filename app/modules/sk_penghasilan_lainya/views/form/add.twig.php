<form class="form-horizontal" action="#" id="form_sk_penghasilan_lainya">
	<input type="hidden" id="sk_penghasilan_lainyaid" name="sk_penghasilan_lainyaid" value="0" />
...
<div class="form-group">
	<label class="col-sm-4 col-lg-3 control-label">Domisili 
		<span class="require">*</span>
				</label>
	<div class="col-sm-8 col-lg-7 controls">
...
<div class="form-group">
	<label class="col-sm-4 col-lg-3 control-label">Penghasilan 
		<span class="require">*</span>
				</label>
	<div class="col-sm-8 col-lg-7 controls">
		<input id="penghasilan" name="penghasilan" type="text" placeholder="Penghasilan" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
