<form class="form-horizontal" action="#" id="form_sk_penghasilan_lainya">
	<input type="hidden" id="sk_penghasilan_lainyaid" name="sk_penghasilan_lainyaid" value="{{sk_penghasilan_lainyaid}}" />
...
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="penghasilan" name="penghasilan" type="text" placeholder="Penghasilan" class="wajib_isi form-control" autocomplete="off"  value="{{detail.penghasilan}}" />
	</div>
</div>
