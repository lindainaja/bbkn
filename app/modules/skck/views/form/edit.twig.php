...
<input type="hidden" id="skckid" name="skckid" value="{{ skckid }}" />
...
<div class="col-sm-4 col-lg-4 controls">
<input id="suku" name="suku" type="text" placeholder="Nama Suku" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{detail.suku}}" />
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<input id="nik" name="nik" type="text" placeholder="Nomor KTP" class="form-control" autocomplete="off" maxlength="50" value="{{ detail.nik }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Domisili <span class="require">*</span></label>
<div class="col-sm-4 col-lg-7 controls">
<input id="domisili" name="domisili" type="text" placeholder="Domisili" class="wajib_isi form-control" autocomplete="off" maxlength="100" value="{{detail.domisili}}" />
</div>
</div>
<!--<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Alamat Asal</label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_asal" id="alamat_asal" class="form-control" placeholder="Alamat Asal">{{ detail.alamat_asal }}</textarea>
</div>
</div> -->
...
<div class="col-sm-8 col-lg-7 controls">
<input id="persyaratan_untuk" name="persyaratan_untuk" type="text" placeholder="Nama Keperluan" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.persyaratan_untuk }}" />
</div>
</div>
<h5>Data Registrasi</h5>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nomor Registrasi </label>
<div class="col-sm-4 col-lg-8 controls">
<input id="no_reg" name="no_reg" type="text" placeholder="Nomor Registrasi" class=" form-control" autocomplete="off" maxlength="100" value="{{detail.no_reg}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Tanggal Registrasi </label>
<div class="col-sm-4 col-lg-3 controls">
...
<h5>Data Kepolisian</h5>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nomor Polisi </label>
<div class="col-sm-4 col-lg-8 controls">
<input id="nopol" name="nopol" type="text" placeholder="Nomor Polisi" class=" form-control" autocomplete="off" maxlength="100" value="{{detail.nopol}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Tanggal No.Pol </label>
<div class="col-sm-4 col-lg-3 controls">
<input id="tgl_nopol" name="tgl_nopol" type="text" placeholder="dd/mm/yyyy" class="  date-picker form-control input-small" autocomplete="off" value="{{ format_datepicker(detail.tgl_nopol) }}" />
</div>
</div>
<h5>Data Kapolsek</h5>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pol_nama" name="pol_nama" type="text" placeholder="Nama Kapolsek" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{detail.pol_nama}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NIP </label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pol_nip" name="pol_nip" type="text" placeholder="NIP Jika Ada" class=" form-control" autocomplete="off" maxlength="50" value="{{detail.pol_nip}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Jabatan </label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pol_jabatan" name="pol_jabatan" type="text" placeholder="Jabatan Jika Ada" class=" form-control" autocomplete="off" maxlength="100" value="{{detail.pol_jabatan}}" />
</div>
</div>
...
<label class="col-sm-4 col-lg-4 control-label">Nama <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pp_nama" name="pp_nama" type="text" placeholder="Nama Pemberi Pernyataan" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{detail.pp_nama}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NIP </label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pp_nip" name="pp_nip" type="text" placeholder="NIP Jika Ada" class=" form-control" autocomplete="off" maxlength="50" value="{{detail.pp_nip}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Jabatan  </label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pp_jabatan" name="pp_jabatan" type="text" placeholder="Jabatan Jika Ada" class=" form-control" autocomplete="off" maxlength="100" value="{{detail.pp_jabatan}}" />
</div>
</div>
