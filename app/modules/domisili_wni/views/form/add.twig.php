...
<input type="hidden" id="domisili_wniid" name="domisili_wniid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<textarea id="alamat" name="alamat"  placeholder="Alamat" class="wajib_isi form-control" ></textarea>
</div>
</div>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="lingkungan" name="lingkungan" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" maxlength="400" />
</div>
</div>
