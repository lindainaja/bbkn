<form class="form-horizontal" action="#" id="form_sk_hak_milik_kapal">
	<input type="hidden" id="sk_hak_milik_kapalid" name="sk_hak_milik_kapalid" value="{{sk_hak_milik_kapalid}}" />
...
{{ dropdown_agama|raw }}
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="no_ktp" name="no_ktp" type="text" placeholder="Nomor KK/KTP" class="wajib_isi form-control" autocomplete="off"  value="{{detail.no_ktp}}" />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="nama_kapal" name="nama_kapal" type="text" placeholder="Nama Kapal" class="wajib_isi form-control" autocomplete="off"  value="{{detail.nama_kapal}}" />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="daerah_operasi" name="daerah_operasi" type="text" placeholder="Daerah Operasi" class="wajib_isi form-control" autocomplete="off"  value="{{detail.daerah_operasi}}" />
	</div>
</div>
