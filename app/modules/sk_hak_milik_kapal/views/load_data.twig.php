...
<table class="table table-striped" id="table_sk_hak_milik_kapal" width="100%">
    <thead>
        <tr>
...
<th><div align="center">Nomor KTP</div></th>
<th><div align="center">Nama Kapal</div></th>
<th><div align="center">Daerah Operasi</div></th>
...
<td>{{ result_val.no }}</td> <td>{{ result_val.nama }}</td> 
<td>{{ result_val.no_ktp }}</td>
<td>{{ result_val.nama_kapal }}</td>
<td>{{ result_val.daerah_operasi }}</td>


            <td align="center">{{ result_val.download }} </td>
