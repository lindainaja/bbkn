...
class Sk_hak_milik_kapal extends Crud_Controller
{
    ...
    {
        $sk_hak_milik_kapalid = $this->input->post('sk_hak_milik_kapalid');
        $detail = $this->m_sk_hak_milik_kapal->detail_data($sk_hak_milik_kapalid);
        // $detail_data = $this->m_sk_hak_milik_kapal->detail_data_detail($sk_hak_milik_kapalid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$pekerjaan   = pekerjaan_dropdown();
	$agama       = agama_2_dropdown();
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
            ...
            $ret = $row;
            $camat = $this->m_sk_hak_milik_kapal->get_camat();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_hak_milik_kapal/controllers/Sk_hak_milik_kapal.php
