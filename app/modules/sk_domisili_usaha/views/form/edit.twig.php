...
<form class="form-horizontal" action="#" id="form_sk_domisili_usaha">
	<div class="tab-content" style="padding-top: 1em">
		<div id="main" class="tab-pane fade in active">
			<input type="hidden" id="sk_domisili_usahaid" name="sk_domisili_usahaid" value="{{ sk_domisili_usahaid }}" />
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input value="{{ detail.no }}" id="no" name="no" type="text" placeholder="Nomor" class="wajib_isi form-control" autocomplete="off" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Nomor KTP/PASPORT <span class="require">*</span></label>
				<div class="col-sm-4 col-lg-4 controls">
					<input id="nik" name="nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" value="{{ detail.nik }}" />
				</div>
				<div class="col-sm-4 col-lg-4 controls">
					<input id="pasport" name="pasport" type="text" placeholder="PASPORT" class="wajib_isi form-control" autocomplete="off" value="{{ detail.pasport }}" />
				</div>
			</div>
			<div class="form-group">
			...
			<!-- <div class="form-group">
						...
						<div class="col-sm-8 col-lg-8 controls">
									<input id="no_bapl" name="no_bapl" type="text" placeholder="Nomor BAPL" class="wajib_isi form-control" autocomplete="off" value="{{ detail.no_bapl }}" />
						</div>
			</div> -->
			<h5>Data Perusahaan</h5>
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Nama Perusahaan<span class="require">*</span></label>
				<div class="col-sm-8 col-lg-8 controls">
					<input id="nama_usaha" name="nama_usaha" type="text" placeholder="Nama Perusahaan" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.nama_usaha }}" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Jenis Usaha<span class="require">*</span></label>
				<div class="col-sm-8 col-lg-8 controls">
					<input id="jenis_usaha" name="jenis_usaha" type="text" placeholder="Jenis Usaha" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.jenis_usaha }}" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="status_bangunan" name="status_bangunan" type="text" placeholder="Status Bangunan" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.status_bangunan }}" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Jumlah Karyawan <span class="require">*</span></label>
				<div class="col-sm-5 col-lg-3 controls input-group">
					<input id="jumlah_karyawan" name="jumlah_karyawan" type="text" placeholder="0" class="wajib_isi form-control angka" onkeypress="return blockNonNumbers(this, event, true, true);" autocomplete="off" maxlength="6" value="{{ detail.jumlah_karyawan }}" />
					<span class="input-group-btn">
			...
			<div class="form-group">
				...
				<div class="col-sm-4 col-lg-4 controls">
					<input id="no_perusahaan" name="no_perusahaan" type="text" placeholder="No. Perusahaan" class="wajib_isi form-control" autocomplete="off" value="{{ detail.no_perusahaan }}" />
				</div>
				<div class="col-sm-4 col-lg-4 controls">
					<input id="tanggal_berdiri" name="tanggal_berdiri" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" value="{{ format_datepicker(detail.tanggal_berdiri) }}" />
				</div>
			</div>
			<div class="form-group">
		...
		<div id="bapl" class="tab-pane">
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input value="{{ detail.no_bapl }}" id="no_bapl" name="no_bapl" type="text" placeholder="Nomor BAPL" class="wajib_isi form-control" autocomplete="off" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Lokasi Usaha
					<span class="require">*</span>
				</label>
				<div class="col-sm-8 col-lg-8 controls">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="sf_toko_ruko" name="sf_toko_ruko" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" value="{{ detail.sf_toko_ruko }}" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="sf_gudang" name="sf_gudang" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" value="{{ detail.sf_gudang }}" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="ruang_kerja_produksi" name="ruang_kerja_produksi" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" value="{{ detail.ruang_kerja_produksi }}" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="mesin_produksi" name="mesin_produksi" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" value="{{ detail.mesin_produksi }}" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 col-lg-3 controls input-group">
					<input id="jml_kry_pria" name="jml_kry_pria" type="text" placeholder="0" class="wajib_isi form-control angka" onkeypress="return blockNonNumbers(this, event, true, true);" autocomplete="off" maxlength="6" value="{{ detail.jml_kry_pria }}" />
					<span class="input-group-btn">
						<span class="btn">Orang</span>
					</span>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 col-lg-3 controls input-group">
					<input id="jml_kry_wanita" name="jml_kry_wanita" type="text" placeholder="0" class="wajib_isi form-control angka" onkeypress="return blockNonNumbers(this, event, true, true);" autocomplete="off" maxlength="6" value="{{ detail.jml_kry_wanita }}" />
					<span class="input-group-btn">
						<span class="btn">Orang</span>
					</span>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 col-lg-3 controls input-group">
					<input id="jml_kry_wna" name="jml_kry_wna" type="text" placeholder="0" class="wajib_isi form-control angka" onkeypress="return blockNonNumbers(this, event, true, true);" autocomplete="off" maxlength="6" value="{{ detail.jml_kry_wna }}" />
					<span class="input-group-btn">
						<span class="btn">Orang</span>
					</span>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 col-lg-3 controls input-group">
					<input id="luas_parkir" name="luas_parkir" type="text" placeholder="0.0" class="wajib_isi form-control angka" onkeypress="return blockNonNumbers(this, event, true, true);" autocomplete="off" maxlength="6" value="{{ detail.luas_parkir }}" />
					<span class="input-group-btn">
						<span class="btn">M<sup>2</sup></span>
					</span>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="tempat_ibadah" name="tempat_ibadah" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off" value="{{ detail.tempat_ibadah }}" />
				</div>
			</div>
			<h5>Hasil Pemeriksaan Lapangan</h5>
			<div class="form-group">
				<label class="col-sm-4 col-lg-4 control-label">Hasil SKDTU<span class="require">*</span></label>
				<div class="col-sm-8 col-lg-8 controls">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="petugas_1" name="petugas_1" type="text" placeholder="Nama Petugas I" class="wajib_isi form-control" autocomplete="off" value="{{ detail.petugas_1 }}" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-8 controls">
					<input id="petugas_2" name="petugas_2" type="text" placeholder="Nama Petugas II" class="wajib_isi form-control" autocomplete="off" value="{{ detail.petugas_2 }}" />
				</div>
			</div>
		</div>
	</div>
