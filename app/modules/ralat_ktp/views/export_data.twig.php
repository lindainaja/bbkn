...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td align="center"><strong>Ralat NIK 1</strong></td>
        <td align="center"><strong>Ralat NIK 2</strong></td>
        <td align="center"><strong>Ralat NIK 3</strong></td>
        <td align="center"><strong>Ralat NIK 4</strong></td>
    </tr>
{% if count_result != 0 %}
...
<tr>
                ...
                <td>&nbsp;{{ result_val.nik_1 }}</td>
                <td>&nbsp;{{ result_val.nik_2 }}</td>
                <td>&nbsp;{{ result_val.nik_3 }}</td>
                <td>&nbsp;{{ result_val.nik_4 }}</td>
            </tr>
