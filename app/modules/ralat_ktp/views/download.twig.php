...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Benar nama tersebut diatas adalah warga  Kelurahan {{ detail.nama_kel|upper }} Kecamatan {{ detail.nama_kec|upper }} {{ detail.nama_kab|upper }}.</td>

    </tr>
  <tr>

        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Bahwa Nama tersebut dengan {{ text }} Adalah Satu Orang yang sama.</td>
