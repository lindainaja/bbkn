<form class="form-horizontal" action="#" id="form_ralat_ktp">
<input type="hidden" id="ralat_ktpid" name="ralat_ktpid" value="{{ ralat_ktpid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="no" name="no" type="text" placeholder="Nomor" class="form-control" autocomplete="off" maxlength="100" value="{{ detail.no }}" />
</div>
</div>
<div class="form-group">
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Ralat NIK 1 <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nik_1" name="nik_1" type="text" placeholder="Ralat NIK 1" class="form-control" autocomplete="off" maxlength="25" value="{{ detail.nik_1 }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Ralat NIK 2 <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nik_2" name="nik_2" type="text" placeholder="Ralat NIK 2" class="form-control" autocomplete="off" maxlength="25" value="{{ detail.nik_2 }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Ralat NIK 3</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nik_3" name="nik_3" type="text" placeholder="Ralat NIK 3" class="form-control" autocomplete="off" maxlength="25" value="{{ detail.nik_3 }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Ralat NIK 4</label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nik_4" name="nik_4" type="text" placeholder="Ralat NIK 4" class="form-control" autocomplete="off" maxlength="25" value="{{ detail.nik_4 }}" />
</div>
</div>
