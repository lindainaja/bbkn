...
class Sk_ghoib extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_ghoibid = $this->input->post('sk_ghoibid');
$detail = $this->m_sk_ghoib->detail_data($sk_ghoibid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
//D:/xampp/htdocs/babakan/app/modules/sk_ghoib/controllers/Sk_ghoib.php
