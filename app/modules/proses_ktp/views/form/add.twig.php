...
<input type="hidden" id="proses_ktpid" name="proses_ktpid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="no" name="no" type="text" placeholder="Nomor" class="form-control" autocomplete="off" maxlength="100" />
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<input id="sbg_persyaratan" name="sbg_persyaratan" type="text" placeholder="Sebagai Peryaratan" class="form-control" autocomplete="off" maxlength="250" />
</div>
</div>
