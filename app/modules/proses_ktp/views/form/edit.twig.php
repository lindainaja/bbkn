<form class="form-horizontal" action="#" id="form_proses_ktp">
<input type="hidden" id="proses_ktpid" name="proses_ktpid" value="{{ proses_ktpid }}" />
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Sebagai Peryaratan <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="sbg_persyaratan" name="sbg_persyaratan" type="text" placeholder="Sebagai Peryaratan" class="form-control" autocomplete="off" maxlength="250" value="{{ detail.sbg_persyaratan }}" />
</div>
</div>
