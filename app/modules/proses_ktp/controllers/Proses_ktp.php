...
class Proses_ktp extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);;
    ...
    {
        $proses_ktpid = $this->input->post('proses_ktpid');
$detail = $this->m_proses_ktp->detail_data($proses_ktpid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
//D:/xampp/htdocs/babakan/app/modules/proses_ktp/controllers/Proses_ktp.php
