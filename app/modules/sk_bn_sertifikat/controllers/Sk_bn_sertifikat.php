...
class Sk_bn_sertifikat extends Crud_Controller
{
    ...
    {
        $sk_bn_sertifikatid = $this->input->post('sk_bn_sertifikatid');
        $detail = $this->m_sk_bn_sertifikat->detail_data($sk_bn_sertifikatid);
        // $detail_data = $this->m_sk_bn_sertifikat->detail_data_detail($sk_bn_sertifikatid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$status_perkawinan  = status_kawin_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
	$agama       = agama_2_dropdown();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_bn_sertifikat/controllers/Sk_bn_sertifikat.php
