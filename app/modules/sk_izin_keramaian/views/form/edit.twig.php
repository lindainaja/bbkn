...
<input type="hidden" id="sk_izin_keramaianid" name="sk_izin_keramaianid" value="{{ sk_izin_keramaianid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="acara" name="acara" type="text" placeholder="Kegiatan" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.acara }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Tanggal <span class="require">*</span></label>
