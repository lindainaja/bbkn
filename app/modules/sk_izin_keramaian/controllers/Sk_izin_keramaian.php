...
class Sk_izin_keramaian extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_izin_keramaianid = $this->input->post('sk_izin_keramaianid');
$detail = $this->m_sk_izin_keramaian->detail_data($sk_izin_keramaianid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
//D:/xampp/htdocs/babakan/app/modules/sk_izin_keramaian/controllers/Sk_izin_keramaian.php
