...
<table class="table table-striped" id="table_sk_kebakaran" width="100%">
    <thead>
        <tr>
...
<th><div align="center">Tanggal Kebakaran</div></th>
<th><div align="center">Lokasi Kebakaran</div></th>
...
<td>{{ format_datepicker(result_val.tanggal_kebakaran) }}</td>
