<form class="form-horizontal" action="#" id="form_sk_kebakaran">
	<input type="hidden" id="sk_kebakaranid" name="sk_kebakaranid" value="{{sk_kebakaranid}}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="tanggal_kebakaran" name="tanggal_kebakaran" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" value="{{format_datepicker(detail.tanggal_kebakaran)}}"  />
</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="lokasi" name="lokasi" type="text" placeholder="Lokasi Kebakaran" class="wajib_isi form-control" autocomplete="off"  value="{{detail.lokasi}}" />
	</div>
</div>
<h5>Item Yang Terbakar</h5>
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="yang_terbakar_1" name="yang_terbakar_1" type="text" placeholder="Item 1" class="wajib_isi form-control" autocomplete="off"  value="{{detail.yang_terbakar_1}}" />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="yang_terbakar_2" name="yang_terbakar_2" type="text" placeholder="Item 2" class="wajib_isi form-control" autocomplete="off"  value="{{detail.yang_terbakar_2}}" />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="yang_terbakar_3" name="yang_terbakar_3" type="text" placeholder="Item 3" class="wajib_isi form-control" autocomplete="off"  value="{{detail.yang_terbakar_3}}" />
	</div>
</div>
    <div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="yang_terbakar_4" name="yang_terbakar_4" type="text" placeholder="Item 4" class="wajib_isi form-control" autocomplete="off"  value="{{detail.yang_terbakar_4}}" />
	</div>
</div>
