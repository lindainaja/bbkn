...
class Sk_kebakaran extends Crud_Controller
{
    ...
    {
        $sk_kebakaranid = $this->input->post('sk_kebakaranid');
        $detail = $this->m_sk_kebakaran->detail_data($sk_kebakaranid);
        // $detail_data = $this->m_sk_kebakaran->detail_data_detail($sk_kebakaranid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$pekerjaan   = pekerjaan_dropdown();
	$status_perkawinan  = status_kawin_2_dropdown();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_kebakaran/controllers/Sk_kebakaran.php
