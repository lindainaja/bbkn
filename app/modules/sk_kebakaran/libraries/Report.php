...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "SK Kebakaran";
	...
	*/
	...
	'alamat' => 'Alamat',
	'tanggal_kebakaran' => 'Tanggal Kebakaran',
	'lokasi' => 'Lokasi Kebakaran',
 
	'yang_terbakar_1' => 'Yang Terbakar 1',
	'yang_terbakar_2' => 'Yang Terbakar 2',
	'yang_terbakar_3' => 'Yang Terbakar 3',
	'yang_terbakar_4' => 'Yang Terbakar 4',
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:P8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("P8:P{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:P{$rownum}","bottom");
	...
	protected function modifyRowData($row){
        ...
        $ret['tanggal_kebakaran'] = format_tanggal_khusus_indo($row['tanggal_kebakaran']);
...
}//D:/xampp/htdocs/babakan/app/modules/sk_kebakaran/libraries/Report.php
