<form class="form-horizontal" action="#" id="form_permohonan_kehendak_perkawinan">
	<input type="hidden" id="permohonan_kehendak_perkawinanid" name="permohonan_kehendak_perkawinanid" value="0" />
...
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="nama_pemohon" name="nama_pemohon" type="text" placeholder="Nama Pemohon" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="syarat_a" name="syarat_a" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="syarat_b" name="syarat_b" type="text" placeholder="" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<h5>Data Pernikahan</h5>
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="s_nama" name="s_nama" type="text" placeholder="Nama Calon Suami" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="i_nama" name="i_nama" type="text" placeholder="Nama Calon Istri" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<input id="tanggal_acara" name="tanggal_acara" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" />
</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="waktu_acara" name="waktu_acara" type="text" placeholder="Waktu Acara" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="tempat_acara" name="tempat_acara" type="text" placeholder="Tempat Acara" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="tanggal_terima" name="tanggal_terima" type="text" placeholder="dd/mm/yyyy" class="wajib_isi date-picker form-control input-small" autocomplete="off" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-3 control-label">Nama Kepala KUA<span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nama_kepala_kua" name="nama_kepala_kua" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<!-- <div class="form-group">
