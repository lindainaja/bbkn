<?php 
class Permohonan_kehendak_perkawinan extends Crud_Controller{
    ...
    {
        $permohonan_kehendak_perkawinanid = $this->input->post('permohonan_kehendak_perkawinanid');
        $detail = $this->m_permohonan_kehendak_perkawinan->detail_data($permohonan_kehendak_perkawinanid);
        // $detail_data = $this->m_permohonan_kehendak_perkawinan->detail_data_detail($permohonan_kehendak_perkawinanid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$negara        = negara_dropdown();
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
