...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="100%" align="center"><strong style="font-size:21px"><u>SURAT KETERANGAN WALI NIKAH</u></strong></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Benar nama tersebut diatas adalah : <strong>{{ detail.status_wali }}</strong> dari Seorang Perempuan :</td>
    ...
    <tr>
        <td colspan="4">Yang akan Menikah Dengan Seorang Laki Laki :</td>
    </tr>
    <tr>
        <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
        ...
        <td>Nama</td>
        <td>:</td>
        <td><strong>{{ detail.pria_nama }}</strong></td>
