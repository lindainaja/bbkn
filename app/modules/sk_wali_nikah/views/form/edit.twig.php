...
<input type="hidden" id="sk_wali_nikahid" name="sk_wali_nikahid" value="{{ sk_wali_nikahid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="status_wali" name="status_wali" type="text" placeholder="contoh : BAPAK KANDUNG" class="wajib_isi form-control" autocomplete="off" maxlength="50" value="{{ detail.status_wali }}" />
</div>
</div>
<div class="form-group">
