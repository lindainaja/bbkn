...
<input type="hidden" id="sk_belum_memiliki_rumahid" name="sk_belum_memiliki_rumahid" value="{{ sk_belum_memiliki_rumahid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="domisili" name="domisili" type="text" placeholder="Domisili" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.domisili}}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NIK <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="nik" name="nik" value="{{ detail.nik}}" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="30"   />
</div>
</div>
