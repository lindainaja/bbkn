...
class Sk_belum_memiliki_rumah extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    public function form_edit_data()
    {
        ...
        $sk_belum_memiliki_rumahid = $this->input->post('sk_belum_memiliki_rumahid');
$detail = $this->m_sk_belum_memiliki_rumah->detail_data($sk_belum_memiliki_rumahid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
//D:/xampp/htdocs/babakan/app/modules/sk_belum_memiliki_rumah/controllers/Sk_belum_memiliki_rumah.php
