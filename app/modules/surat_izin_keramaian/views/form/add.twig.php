<form class="form-horizontal" action="#" id="form_surat_izin_keramaian">
	<input type="hidden" id="surat_izin_keramaianid" name="surat_izin_keramaianid" value="0" />
	...
	<div class="form-group">
		...
		<div class="col-sm-8 col-lg-7 controls">
		<input value="{{ config_item('no_surat_suffix') }}" id="no" name="no" type="text" placeholder="Nomor" class="wajib_isi form-control" autocomplete="off" maxlength="100" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-8 col-lg-7 controls">
		<input id="acara" name="acara" type="text" placeholder="Nama Acara" class="wajib_isi form-control" autocomplete="off" maxlength="250" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-8 col-lg-7 controls">
		<textarea name="hiburan" id="hiburan" class="wajib_isi form-control" placeholder="Hiburan"></textarea>
		</div>
	</div>
