<form class="form-horizontal" action="#" id="form_surat_izin_keramaian">
<input type="hidden" id="surat_izin_keramaianid" name="surat_izin_keramaianid" value="{{ surat_izin_keramaianid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="acara" name="acara" type="text" placeholder="Nama Acara" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.acara }}" />
</div>
</div>
<div class="form-group">
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Waktu/Jam <span class="require">*</span></label>
<div class="col-sm-2 col-lg-2 controls input-group">
<a class="input-group-addon" href="javascript:;">
<i class="fa fa-clock-o"></i>
</a>
<input class="form-control timepicker-24" name="jam_acara_mulai" id="jam_acara_mulai" type="text" placeholder="H:i" value="{{ detail.jam_acara_mulai }}" >
</div>
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Alamat Acara<span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="alamat_acara" id="alamat_acara" class="wajib_isi form-control" placeholder="Alamat">{{ detail.alamat_acara }}</textarea>
</div>
</div>
<div class="form-group">
		<label class="col-sm-4 col-lg-4 control-label">Nama Hiburan<span class="require">*</span> </label>
		<div class="col-sm-8 col-lg-7 controls">
		<textarea name="hiburan" id="hiburan" class="wajib_isi form-control" placeholder="Hiburan">{{ detail.hiburan }}</textarea>
		</div>
	</div>
