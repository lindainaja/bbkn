...
class Report  extends ExcelReport
{
	...
	protected $namaPelayanan = "Surat Izin Keramaian";
	...
	*/
	...
	protected function setDocumentBody(){
		...
		$this->setBorderStyle("A8:Q8","top");

		$rownum = $rownum-1;
		$this->setBorderStyle("Q8:Q{$rownum}","right");
		$this->setBorderStyle("A8:A{$rownum}","left");

		$this->setBorderStyle("A{$rownum}:Q{$rownum}","bottom");
...
}//D:/xampp/htdocs/babakan/app/modules/surat_izin_keramaian/libraries/Report.php
