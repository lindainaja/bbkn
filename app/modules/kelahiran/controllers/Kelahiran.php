...
class Kelahiran extends Crud_Controller{
...
$data = array(
    ...
    'dropdown_ayah_kewarganegaraan'=> form_dropdown('ayah_kewarganegaraan',$negara,'','id="ayah_kewarganegaraan" class="wajib_isi select2 form-control" style="width:100%" '),
    'dropdown_ibu_kewarganegaraan'=> form_dropdown('ibu_kewarganegaraan',$negara,'','id="ibu_kewarganegaraan" class="wajib_isi select2 form-control" style="width:100%" '),
...
$this->twig->display('form/add.twig.php',$data);;
    ...
    public function form_edit_data()
    {
         $negara         = negara_dropdown();
        $agama          = agama_2_dropdown();
        $kelahiranid = $this->input->post('kelahiranid');
$detail = $this->m_kelahiran->detail_data($kelahiranid);
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
$data = array(
...
}//D:/xampp/htdocs/babakan/app/modules/kelahiran/controllers/Kelahiran.php
