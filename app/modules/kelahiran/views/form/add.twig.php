...
<input type="hidden" id="kelahiranid" name="kelahiranid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="keperluan" id="keperluan" class="wajib_isi form-control" placeholder="Keperluan"></textarea>
</div>
</div>
<h5>Data Anak</h5>
<div class="form-group">
...
<div class="col-sm-4 col-lg-4 controls input-group">
<a class="input-group-addon" href="javascript:;">
<i class="fa fa-clock-o"></i>
</a>
<input class="wajib_isi form-control timepicker-24" name="pukul" id="pukul" type="text" placeholder="H:i" >
</div>
</div> -->
<h5>Data Ibu</h5>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="ibu_nama" name="ibu_nama" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NIK <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="ibu_nik" name="ibu_nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
...
<input id="ibu_umur" name="ibu_umur" type="text" placeholder="Umur" class="wajib_isi form-control" autocomplete="off" maxlength="18" onkeypress="return blockNonNumbers(this, event, true, true);" />
...
<label class="col-sm-4 col-lg-4 control-label">Nama <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="ayah_nama" name="ayah_nama" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NIK <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="ayah_nik" name="ayah_nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Umur <span class="require">*</span></label>
<div class="col-sm-3 col-lg-3 controls input-group">
<input id="ayah_umur" name="ayah_umur" type="text" placeholder="Umur" class="wajib_isi form-control" autocomplete="off" maxlength="18" onkeypress="return blockNonNumbers(this, event, true, true);" />
<span class="input-group-addon">
Tahun
</span>
</div>
...
<label class="col-sm-4 col-lg-4 control-label">Nama <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pelapor_nama" name="pelapor_nama" type="text" placeholder="Nama" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">NIK <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="pelapor_nik" name="pelapor_nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="150" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Umur <span class="require">*</span></label>
<div class="col-sm-3 col-lg-3 controls input-group">
<input id="pelapor_umur" name="pelapor_umur" type="text" placeholder="Umur" class="wajib_isi form-control" autocomplete="off" maxlength="18" onkeypress="return blockNonNumbers(this, event, true, true);" />
<span class="input-group-addon">
Tahun
</span>
</div>
...
<label class="col-sm-4 col-lg-4 control-label">Alamat <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<textarea name="pelapor_alamat" id="pelapor_alamat" class="wajib_isi form-control" placeholder="Alamat"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Hubungan pelapor dengan bayi <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="hubungan_pelapor" name="hubungan_pelapor" type="text" placeholder="Hubungan pelapor dengan bayi" class="wajib_isi form-control" autocomplete="off" maxlength="100" />
</div>
</div> -->
