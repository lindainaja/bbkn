...
<input type="hidden" id="surat_pernyataanid" name="surat_pernyataanid" value="{{ surat_pernyataanid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="tertuju_status" name="tertuju_status" type="text" placeholder="contoh : Istri/Suami" class="wajib_isi form-control" autocomplete="off" maxlength="30" value="{{ detail.tertuju_status }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama <span class="require">*</span></label>
...
<div class="col-sm-8 col-lg-7 controls">
<input id="saksi_1" name="saksi_1" type="text" placeholder="Saksi 1" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.saksi_1 }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Saksi 2 </label>
<div class="col-sm-8 col-lg-7 controls">
<input id="saksi_2" name="saksi_2" type="text" placeholder="Saksi 2" class="form-control" autocomplete="off" maxlength="150" value="{{ detail.saksi_2 }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">RT <span class="require">*</span></label>
<div class="col-sm-2 col-lg-2 controls">
<input id="rt" name="rt" type="text" placeholder="RT" class="wajib_isi form-control" autocomplete="off" maxlength="15" value="{{ detail.rt }}" />
</div>
<label class="col-sm-1 col-lg-1 control-label">RW <span class="require">*</span></label>
<div class="col-sm-2 col-lg-2 controls">
<input id="rw" name="rw" type="text" placeholder="RW" class="wajib_isi form-control" autocomplete="off" maxlength="15" value="{{ detail.rw }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama RT <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="rt_nama" name="rt_nama" type="text" placeholder="Nama RT" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.rt_nama }}" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Nama RW <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="rw_nama" name="rw_nama" type="text" placeholder="Nama RW" class="wajib_isi form-control" autocomplete="off" maxlength="150" value="{{ detail.rw_nama }}" />
</div>
</div>
{{ syarat_form|raw }}
</form>
