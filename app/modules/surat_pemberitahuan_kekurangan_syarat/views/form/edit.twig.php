...
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="nama_syarat_sudah_lengkap" name="nama_syarat_sudah_lengkap" type="text" placeholder="Sebutkan" class="wajib_isi form-control" autocomplete="off"  value="{{detail.nama_syarat_sudah_lengkap}}"/>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="nama_syarat_belum_lengkap" name="nama_syarat_belum_lengkap" type="text" placeholder="Sebutkan" class="wajib_isi form-control" autocomplete="off"  value="{{detail.nama_syarat_belum_lengkap}}"/>
	</div>
</div>
