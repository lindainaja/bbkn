...
<input type="hidden" id="sk_belum_pernah_nikahid" name="sk_belum_pernah_nikahid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<input id="persyaratan_untuk" name="persyaratan_untuk" type="text" placeholder="Persyaratan Untuk" class="wajib_isi form-control" autocomplete="off" maxlength="250" />
</div>
</div>
