<form class="form-horizontal" action="#" id="form_sk_belum_pernah_nikah">
<input type="hidden" id="sk_belum_pernah_nikahid" name="sk_belum_pernah_nikahid" value="{{ sk_belum_pernah_nikahid }}" />
...
<div class="form-group">
<label class="col-sm-4 col-lg-4 control-label">Persyaratan Untuk <span class="require">*</span></label>
<div class="col-sm-8 col-lg-7 controls">
<input id="persyaratan_untuk" name="persyaratan_untuk" type="text" placeholder="Persyaratan Untuk" class="wajib_isi form-control" autocomplete="off" maxlength="250" value="{{ detail.persyaratan_untuk }}" />
</div>
</div>
