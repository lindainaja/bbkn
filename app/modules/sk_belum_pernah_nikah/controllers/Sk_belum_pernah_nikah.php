...
class Sk_belum_pernah_nikah extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_belum_pernah_nikahid = $this->input->post('sk_belum_pernah_nikahid');
$detail = $this->m_sk_belum_pernah_nikah->detail_data($sk_belum_pernah_nikahid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
$this->twig->display('form/edit.twig.php',$data);
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
            ...
            // $ret['ayah_ttl'] = $ret['ayah_tempat_lahir'].', '.$ret['ayah_tanggal_lahir'];
            // $ret['ibu_ttl'] = $ret['ibu_tempat_lahir'].', '.$ret['ibu_tanggal_lahir'];
...
//D:/xampp/htdocs/babakan/app/modules/sk_belum_pernah_nikah/controllers/Sk_belum_pernah_nikah.php
