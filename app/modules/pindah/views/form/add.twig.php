...
<input type="hidden" id="pindahid" name="pindahid" value="0" />
...
<div class="col-sm-6 col-lg-5 controls">
<input id="pindah_antar" name="pindah_antar" type="text" placeholder="Pindah Antar" class="wajib_isi form-control" autocomplete="off" maxlength="50" />
</div>
</div>
...
<div class="col-sm-6 col-lg-5 controls">
<input id="dusun_pindah" name="dusun_pindah" type="text" placeholder="Dusun" class="form-control" autocomplete="off" maxlength="200" />
</div>
</div>
<div class="form-group">
<label class="col-sm-3 col-lg-2 control-label">Kodepos </label>
