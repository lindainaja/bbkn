...
class Sk_keterangan_orangtua extends Crud_Controller
{
	...
	'c_dropdown_kewarganegaraan' => form_dropdown('c_kewarganegaraan',$negara,'INDONESIA','id="c_kewarganegaraan" class="wajib_isi select2 form-control" style="width:100%" '),
	'c_dropdown_agama' => form_dropdown('c_agama',$agama,'','id="c_agama" class="wajib_isi select2 form-control" style="width:100%" '),
	'c_dropdown_pekerjaan' => form_dropdown('c_pekerjaan',$pekerjaan,'','id="c_pekerjaan" class="wajib_isi select2 form-control" style="width:100%" '),
    ...
    {
        $sk_keterangan_orangtuaid = $this->input->post('sk_keterangan_orangtuaid');
        $detail = $this->m_sk_keterangan_orangtua->detail_data($sk_keterangan_orangtuaid);
        // $detail_data = $this->m_sk_keterangan_orangtua->detail_data_detail($sk_keterangan_orangtuaid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$negara        = negara_dropdown();
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
	...
	'c_dropdown_kewarganegaraan' => form_dropdown('c_kewarganegaraan',$negara,$detail['c_kewarganegaraan'],'id="c_kewarganegaraan" class="wajib_isi select2 form-control" style="width:100%" '),
...
}//D:/xampp/htdocs/babakan/app/modules/sk_keterangan_orangtua/controllers/Sk_keterangan_orangtua.php
