<form class="form-horizontal" action="#" id="form_sk_keterangan_orangtua">
	<input type="hidden" id="sk_keterangan_orangtuaid" name="sk_keterangan_orangtuaid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="ayah_tempat_tinggal" id="ayah_tempat_tinggal" class="wajib_isi form-control" placeholder="Tempat Tinggal Ayah "></textarea>
</div>
</div>
<h5>Data Ibu</h5>
    <div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="ibu_tempat_tinggal" id="ibu_tempat_tinggal" class="wajib_isi form-control" placeholder="Tempat Tinggal Ibu"></textarea>
</div>
</div>
<h5>Data Calon Mempelai</h5>
	...
	<div class="col-sm-8 col-lg-7 controls">
		<input id="c_nama" name="c_nama" type="text" placeholder="Nama Calon" class="wajib_isi form-control" autocomplete="off"  />
	</div>
</div>
    <div class="form-group">
...
<div class="col-sm-8 col-lg-7 controls">
<textarea name="c_tempat_tinggal" id="c_tempat_tinggal" class="wajib_isi form-control" placeholder="Tempat Tinggal Calon"></textarea>
</div>
</div>
