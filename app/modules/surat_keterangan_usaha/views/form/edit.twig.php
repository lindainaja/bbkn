...
<input type="hidden" id="surat_keterangan_usahaid" name="surat_keterangan_usahaid" value="{{ surat_keterangan_usahaid }}" />
...
<div class="form-group">
		...
		<div class="col-sm-8 col-lg-7 controls">
		<input value="{{ detail.nik }}" id="nik" name="nik" type="text" placeholder="NIK" class="wajib_isi form-control" autocomplete="off" maxlength="250" />
		</div>
	</div>
<div class="form-group">
...
<div class="form-group">
		...
		<div class="col-sm-8 col-lg-7 controls">
		<input id="bidang_usaha" name="bidang_usaha" type="text" placeholder="Bidang Usaha" class="wajib_isi form-control" autocomplete="off" maxlength="250"  value="{{ detail.bidang_usaha }}" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 col-lg-4 control-label">Lokasi <span class="require">*</span></label>
		<div class="col-sm-8 col-lg-7 controls">
		<input id="lokasi" name="lokasi" value="{{ detail.lokasi }}" type="text" placeholder="Lokasi" class="wajib_isi form-control" autocomplete="off" maxlength="250" />
		</div>
	</div>
	<div class="form-group">
