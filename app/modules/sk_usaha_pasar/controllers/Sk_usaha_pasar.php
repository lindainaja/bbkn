...
class Sk_usaha_pasar extends Crud_Controller
{
    ...
    {
        $sk_usaha_pasarid = $this->input->post('sk_usaha_pasarid');
        $detail = $this->m_sk_usaha_pasar->detail_data($sk_usaha_pasarid);
        // $detail_data = $this->m_sk_usaha_pasar->detail_data_detail($sk_usaha_pasarid);
        	$kel  = kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
	$agama       = agama_2_dropdown();
	$pekerjaan   = pekerjaan_dropdown();
    ...
    public function download()
    {
        ...
        $options['rowModifierCallback'] = function ($row){
            ...
            $camat = $this->m_sk_usaha_pasar->get_camat();
...
}//D:/xampp/htdocs/babakan/app/modules/sk_usaha_pasar/controllers/Sk_usaha_pasar.php
