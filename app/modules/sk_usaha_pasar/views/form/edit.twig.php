<form class="form-horizontal" action="#" id="form_sk_usaha_pasar">
	<input type="hidden" id="sk_usaha_pasarid" name="sk_usaha_pasarid" value="{{sk_usaha_pasarid}}" />
...
<div class="col-sm-8 col-lg-7 controls">
		<input id="luas_tempat_usaha" name="luas_tempat_usaha" type="text" placeholder="Luas Tempat Usaha" class="wajib_isi form-control" autocomplete="off"   value="{{detail.luas_tempat_usaha}}"  />
