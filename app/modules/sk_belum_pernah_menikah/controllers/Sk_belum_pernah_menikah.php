...
class Sk_belum_pernah_menikah extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);
    ...
    {
        $sk_belum_pernah_menikahid = $this->input->post('sk_belum_pernah_menikahid');
$detail = $this->m_sk_belum_pernah_menikah->detail_data($sk_belum_pernah_menikahid);
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
$kel		 	= kel_3_dropdown($this->no_prop,$this->no_kab,$this->no_kec,$this->no_kel);
...
//D:/xampp/htdocs/babakan/app/modules/sk_belum_pernah_menikah/controllers/Sk_belum_pernah_menikah.php
