...
<input type="hidden" id="sk_belum_pernah_menikahid" name="sk_belum_pernah_menikahid" value="0" />
...
<div class="col-sm-8 col-lg-7 controls">
<textarea id="keperluan" name="keperluan"  type="text" placeholder="Keperluan" class="wajib_isi form-control" autocomplete="off"></textarea>
</div>
</div>
