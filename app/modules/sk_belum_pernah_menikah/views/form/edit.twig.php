<form class="form-horizontal" action="#" id="form_sk_belum_pernah_menikah">
<input type="hidden" id="sk_belum_pernah_menikahid" name="sk_belum_pernah_menikahid" value="{{ sk_belum_pernah_menikahid }}" />
...
<div class="col-sm-8 col-lg-7 controls">
<textarea id="keperluan" name="keperluan"  type="text" placeholder="Keperluan" class="wajib_isi form-control" autocomplete="off">{{ detail.keperluan }}</textarea>
</div>
</div>
