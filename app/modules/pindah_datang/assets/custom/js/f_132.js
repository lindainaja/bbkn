...
gc.onShowForm = function(modal,mode,ajax_url,e){
	...
	legend_before(modal,'status_no_kk_pindah_no','Data Daerah Tujuan');
	legend_before(modal,'ttd_nama','Data Tanda Tangan');
	attach_ag_after(modal,'rt_pindah');
	...
	$exchange_field_config = [
		['dusun_dukuh_kampung','no_dusun_dukuh_kampung','2'],
		['no','date','2'],
		['rt_asal','rw_asal','1'],
	...
	setTimeout(function(){
		var numeric_fields = ['no_dusun_dukuh_kampung','no_kk_asal','tlp_asal','kodepos_asal','rt_asal','rw_asal','rt_pindah','rw_pindah','nik_pemohon','no_kk_pindah','nik_kep_kel_pindah'];
