<?
class F_129  extends PD
{
	public $table_name = 't_pindah_wni_129';
	...
	{	
        ...
        $c->unset_read();
        $c->add_custom_form_css($this->asset_url('custom/css/f_129.css'));
        $c->add_custom_list_css($this->asset_url('custom/css/table.css'));
		$c->add_custom_form_js($this->asset_url('custom/js/f_129.js'));
        $c->set_subject('Data F-1.29');
        /*******************************************************************************/
    ...
    public function download_xlsx($pk)
    {
        ...
        // $sheet->setCellValue('W77',$row['ttd_jabatan']);
        $sheet->setCellValue('X81',$row['nama_pemohon']);
        $sheet->setCellValue('B81',$row['nama_petugas_registrasi']);
        $sheet->setCellValue('X82',$row['ttd_nip']);
        ...
        $sheet->setCellValue("W75", $row['nama_kelurahan'] . ", " . $row['tanggal_surat']);
