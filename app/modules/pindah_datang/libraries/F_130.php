<?
class F_130  extends PD
{
	public $table_name = 't_pindah_wni_130';
	...
	{	
        ...
        $c->unset_read();
        $c->add_custom_form_css($this->asset_url('custom/css/f_130.css'));
        $c->add_custom_list_css($this->asset_url('custom/css/table.css'));
		$c->add_custom_form_js($this->asset_url('custom/js/f_130.js'));
        $c->set_subject('Data F-1.30');
        /*******************************************************************************/
    ...
    public function download_xlsx($pk)
    {
        ...
        $sheet->setCellValue('Y77',$row['ttd_jabatan']);
        $sheet->setCellValue('X81',$row['ttd_nama']);
        $sheet->setCellValue('W82',$row['ttd_nip']);
        ...
        $sheet->setCellValue("W75", $row['nama_kecamatan'] . ", " . $row['tanggal_surat']);
