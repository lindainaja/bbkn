 ...
 * 
 */
class F_131  extends PD
{
	public $table_name = 't_pindah_wni_131';
	...
	{	
        ...
        $c->unset_read();
        $c->add_custom_form_css($this->asset_url('custom/css/f_131.css'));
        $c->add_custom_list_css($this->asset_url('custom/css/table.css'));
		$c->add_custom_form_js($this->asset_url('custom/js/f_131.js'));
        $c->set_subject('Data F-1.31');
        /*******************************************************************************/
    ...
    public function download_xlsx($pk)
    {
        ...
        // }
        $sheet->setCellValue('N75',$row['ttd_jabatan']);
        $sheet->setCellValue('L79','('.$row['ttd_nama'].')');
        $sheet->setCellValue('AA79','('.$row['nama_pemohon'].')');
        ...
        $sheet->setCellValue("Z73", $row['nama_kelurahan'] . ", " . $row['tanggal_surat']);
