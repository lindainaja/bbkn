<?
class F_126  extends PD
{
	public $table_name = 't_pindah_wni_126';
	...
	{	
        ...
        $c->unset_read();
        $c->add_custom_form_css($this->asset_url('custom/css/f_126.css'));
        $c->add_custom_list_css($this->asset_url('custom/css/table.css'));
		$c->add_custom_form_js($this->asset_url('custom/js/f_126.js'));
        $c->set_subject('Data F-1.26');
        /*******************************************************************************/
