...
class Domisili_penduduk extends Crud_Controller{
...
$this->twig->display('form/add.twig.php',$data);;
    ...
    {
        // $golongan_darah = array(''=>'- - -  Pilih Gol Darah  - - -')+ config_item('gol_darah') + array('Tidak Tahu'=>'Tidak Tahu');
        $domisili_pendudukid = $this->input->post('domisili_pendudukid');
$detail = $this->m_domisili_penduduk->detail_data($domisili_pendudukid);
// $status_perkawinan	= status_kawin_2_dropdown();
$negara		 	= negara_dropdown();
$agama 			= agama_2_dropdown();
$pekerjaan	 	= pekerjaan_dropdown();
...
//D:/xampp/htdocs/babakan/app/modules/domisili_penduduk/controllers/Domisili_penduduk.php
